...
class $ClienteContactoLocalTableTable extends ClienteContactoLocalTable
    with TableInfo<$ClienteContactoLocalTableTable, ClienteContactoLocalDTO> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $ClienteContactoLocalTableTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _clienteIdMeta =
      const VerificationMeta('clienteId');
  @override
  late final GeneratedColumn<String> clienteId = GeneratedColumn<String>(
  ...
  late final GeneratedColumn<String> enviado = GeneratedColumn<String>(
      ...
      requiredDuringInsert: false,
      defaultValue: const Constant('N'));
  static const VerificationMeta _tratadoMeta =
      const VerificationMeta('tratado');
  @override
  late final GeneratedColumn<String> tratado = GeneratedColumn<String>(
      'TRATADO', aliasedName, false,
      type: DriftSqlType.string,
      requiredDuringInsert: false,
      defaultValue: const Constant('N'));
  ...
  @override
  String get aliasedName => _alias ?? 'CLIENTES_CONTACTOS_LOCAL_IMP';
  @override
  String get actualTableName => 'CLIENTES_CONTACTOS_LOCAL_IMP';
  @override
  VerificationContext validateIntegrity(
      Insertable<ClienteContactoLocalDTO> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('CLIENTE_ID')) {
    ...
    if (data.containsKey('TRATADO')) {
      context.handle(_tratadoMeta,
          tratado.isAcceptableOrUnknown(data['TRATADO']!, _tratadoMeta));
    }
  ...
  @override
  ClienteContactoLocalDTO map(Map<String, dynamic> data,
      {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return ClienteContactoLocalDTO(
      clienteId: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}CLIENTE_ID'])!,
      ...
      tratado: attachedDatabase.typeMapping
          .read(DriftSqlType.string, data['${effectivePrefix}TRATADO'])!,
  ...
  @override
  $ClienteContactoLocalTableTable createAlias(String alias) {
    return $ClienteContactoLocalTableTable(attachedDatabase, alias);
  }
}

class ClienteContactoLocalTableCompanion
    extends UpdateCompanion<ClienteContactoLocalDTO> {
  final Value<String> clienteId;
  ...
  final Value<String> tratado;
  final Value<String> deleted;
  const ClienteContactoLocalTableCompanion({
    this.clienteId = const Value.absent(),
    ...
    this.tratado = const Value.absent(),
    this.deleted = const Value.absent(),
  });
  ClienteContactoLocalTableCompanion.insert({
    required String clienteId,
  ...
  static Insertable<ClienteContactoLocalDTO> custom({
    Expression<String>? clienteId,
    ...
    return RawValuesInsertable({
      ...
      if (tratado != null) 'TRATADO': tratado,
      if (deleted != null) 'DELETED': deleted,
    });
  }

  ClienteContactoLocalTableCompanion copyWith(
      {Value<String>? clienteId,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (tratado.present) {
      map['TRATADO'] = Variable<String>(tratado.value);
    }
    if (deleted.present) {
  ...
  @override
  String toString() {
    return (StringBuffer('ClienteContactoLocalTableCompanion(')
          ..write('clienteId: $clienteId, ')
