...
class $VisitaLocalTableTable extends VisitaLocalTable
  ...
  VisitaLocalDTO map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return VisitaLocalDTO(
      ...
      tratada: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $PedidoVentaLineaLocalTableTable extends PedidoVentaLineaLocalTable
  ...
  PedidoVentaLineaLocalDTO map(
    ...
    return PedidoVentaLineaLocalDTO(
      pedidoVentaAppId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      pedidoVentaLineaAppId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $PedidoVentaLocalTableTable extends PedidoVentaLocalTable
  ...
  PedidoVentaLocalDTO map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return PedidoVentaLocalDTO(
      ...
      borrador: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $LogTableTable extends LogTable with TableInfo<$LogTableTable, LogDTO> {
  ...
  LogDTO map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return LogDTO(
      ...
      appBuildName: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $CatalogoFavoritoTableTable extends CatalogoFavoritoTable
  ...
  CatalogoDTO map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
    return CatalogoDTO(
      catalogoId: attachedDatabase.typeMapping.read(
        DriftSqlType.int,
      ...
      idiomaId: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      tagBusqueda: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
      ...
      descarga: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $ClienteContactoImpTableTable extends ClienteContactoImpTable
  ...
  ClienteContactoImpDTO map(Map<String, dynamic> data, {String? tablePrefix}) {
    ...
    return ClienteContactoImpDTO(
      ...
      enviado: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
        data['${effectivePrefix}ENVIADO'],
      )!,
      borrar: attachedDatabase.typeMapping.read(
        DriftSqlType.string,
...
class $$VisitaLocalTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get numEmpl =>
      $composableBuilder(column: $table.numEmpl, builder: (column) => column);
  ...
  GeneratedColumn<String> get tratada =>
...
class $$PedidoVentaLocalTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get paisId =>
      $composableBuilder(column: $table.paisId, builder: (column) => column);
  ...
  GeneratedColumn<String> get borrador =>
...
class $$LogTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get appBuild =>
...
class $$CatalogoFavoritoTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get idiomaId =>
...
class $$ClienteContactoImpTableTableAnnotationComposer
  ...
  GeneratedColumn<String> get apellido1 =>
      $composableBuilder(column: $table.apellido1, builder: (column) => column);

  GeneratedColumn<String> get apellido2 =>
      $composableBuilder(column: $table.apellido2, builder: (column) => column);

  GeneratedColumn<String> get telefono1 =>
      $composableBuilder(column: $table.telefono1, builder: (column) => column);

  GeneratedColumn<String> get telefono2 =>
      $composableBuilder(column: $table.telefono2, builder: (column) => column);

  GeneratedColumn<String> get email =>
      $composableBuilder(column: $table.email, builder: (column) => column);

  GeneratedColumn<String> get enviado =>
      $composableBuilder(column: $table.enviado, builder: (column) => column);

  GeneratedColumn<String> get borrar =>
