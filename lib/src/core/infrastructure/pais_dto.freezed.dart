...
abstract class $PaisDTOCopyWith<$Res> {
  ...
  $Res call(
      {@JsonKey(name: 'PAIS_ID') String id,
...
/// @nodoc
class __$$_PaisDTOCopyWithImpl<$Res> extends _$PaisDTOCopyWithImpl<$Res>
    implements _$$_PaisDTOCopyWith<$Res> {
  __$$_PaisDTOCopyWithImpl(_$_PaisDTO _value, $Res Function(_$_PaisDTO) _then)
      : super(_value, (v) => _then(v as _$_PaisDTO));

  @override
  _$_PaisDTO get _value => super._value as _$_PaisDTO;
...
abstract class _PaisDTO extends PaisDTO {
  const factory _PaisDTO(
      {@JsonKey(name: 'PAIS_ID') required final String id,
      @JsonKey(name: 'CODIGO_ISO') final String? isoCode,
