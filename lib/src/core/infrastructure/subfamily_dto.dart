...
import '../domain/subfamily.dart';

part 'subfamily_dto.freezed.dart';
part 'subfamily_dto.g.dart';

// ignore_for_file: invalid_annotation_target

@freezed
class SubfamilyDTO with _$SubfamilyDTO implements Insertable<SubfamilyDTO> {
  const SubfamilyDTO._();
  const factory SubfamilyDTO({
  ...
  factory SubfamilyDTO.fromJson(Map<String, dynamic> json) =>
      _$SubfamilyDTOFromJson(json);
...
class SubfamilyTable extends Table {
  ...
  TextColumn get familyId => text().named('FAMILIA_ID')();
