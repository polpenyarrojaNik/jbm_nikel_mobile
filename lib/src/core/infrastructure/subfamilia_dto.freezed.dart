...
SubfamiliaDTO _$SubfamiliaDTOFromJson(Map<String, dynamic> json) {
  return _SubfamiliaDTO.fromJson(json);
}
...
abstract class $SubfamiliaDTOCopyWith<$Res> {
  factory $SubfamiliaDTOCopyWith(
    SubfamiliaDTO value,
    $Res Function(SubfamiliaDTO) then,
...
abstract class _$$SubfamiliaDTOImplCopyWith<$Res>
  ...
  factory _$$SubfamiliaDTOImplCopyWith(
    _$SubfamiliaDTOImpl value,
    $Res Function(_$SubfamiliaDTOImpl) then,
...
class __$$SubfamiliaDTOImplCopyWithImpl<$Res>
  ...
  __$$SubfamiliaDTOImplCopyWithImpl(
    _$SubfamiliaDTOImpl _value,
    $Res Function(_$SubfamiliaDTOImpl) _then,
  ) : super(_value, _then);
...
class _$SubfamiliaDTOImpl extends _SubfamiliaDTO {
  ...
  Map<String, dynamic> toJson() {
    return _$$SubfamiliaDTOImplToJson(this);
  }
}

abstract class _SubfamiliaDTO extends SubfamiliaDTO {
  const factory _SubfamiliaDTO({
    @JsonKey(name: 'SUBFAMILIA_ID') required final String id,
