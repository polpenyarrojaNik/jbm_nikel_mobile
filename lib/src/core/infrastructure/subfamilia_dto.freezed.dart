...
bool operator ==(Object other) {
  final _this = this as SubfamiliaDTO;
...
int get hashCode {
  final _this = this as SubfamiliaDTO;
  return Object.hashAll([runtimeType,_this.id,_this.familiaId,_this.descripcionES,_this.descripcionEN,_this.descripcionFR,_this.descripcionDE,_this.descripcionCA,_this.descripcionGB,_this.descripcionHU,_this.descripcionIT,_this.descripcionNL,_this.descripcionPL,_this.descripcionPT,_this.descripcionRO,_this.descripcionRU,_this.descripcionCN,_this.descripcionEL,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as SubfamiliaDTO;
  return 'SubfamiliaDTO(id: ${_this.id}, familiaId: ${_this.familiaId}, descripcionES: ${_this.descripcionES}, descripcionEN: ${_this.descripcionEN}, descripcionFR: ${_this.descripcionFR}, descripcionDE: ${_this.descripcionDE}, descripcionCA: ${_this.descripcionCA}, descripcionGB: ${_this.descripcionGB}, descripcionHU: ${_this.descripcionHU}, descripcionIT: ${_this.descripcionIT}, descripcionNL: ${_this.descripcionNL}, descripcionPL: ${_this.descripcionPL}, descripcionPT: ${_this.descripcionPT}, descripcionRO: ${_this.descripcionRO}, descripcionRU: ${_this.descripcionRU}, descripcionCN: ${_this.descripcionCN}, descripcionEL: ${_this.descripcionEL}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,id,familiaId,descripcionES,descripcionEN,descripcionFR,descripcionDE,descripcionCA,descripcionGB,descripcionHU,descripcionIT,descripcionNL,descripcionPL,descripcionPT,descripcionRO,descripcionRU,descripcionCN,descripcionEL,lastUpdated,deleted]);
}
