...
abstract class $FamilyDTOCopyWith<$Res> {
  factory $FamilyDTOCopyWith(FamilyDTO value, $Res Function(FamilyDTO) then) =
      _$FamilyDTOCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'FAMILIA_ID') String id,
...
/// @nodoc
abstract class _$$_FamilyDTOCopyWith<$Res> implements $FamilyDTOCopyWith<$Res> {
  factory _$$_FamilyDTOCopyWith(
          _$_FamilyDTO value, $Res Function(_$_FamilyDTO) then) =
      __$$_FamilyDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'FAMILIA_ID') String id,
      @JsonKey(name: 'DESCRIPCION_ES') String descriptionES,
...
/// @nodoc
class __$$_FamilyDTOCopyWithImpl<$Res> extends _$FamilyDTOCopyWithImpl<$Res>
    implements _$$_FamilyDTOCopyWith<$Res> {
  __$$_FamilyDTOCopyWithImpl(
      _$_FamilyDTO _value, $Res Function(_$_FamilyDTO) _then)
      : super(_value, (v) => _then(v as _$_FamilyDTO));

  @override
  _$_FamilyDTO get _value => super._value as _$_FamilyDTO;
...
/// @nodoc
@JsonSerializable()
class _$_FamilyDTO extends _FamilyDTO {
  const _$_FamilyDTO(
  ...
  factory _$_FamilyDTO.fromJson(Map<String, dynamic> json) =>
      _$$_FamilyDTOFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$$_FamilyDTOCopyWith<_$_FamilyDTO> get copyWith =>
      __$$_FamilyDTOCopyWithImpl<_$_FamilyDTO>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_FamilyDTOToJson(
      this,
    );
  }
}

abstract class _FamilyDTO extends FamilyDTO {
  const factory _FamilyDTO(
      {@JsonKey(name: 'FAMILIA_ID') required final String id,
      ...
      @JsonKey(name: 'DELETED') final String deleted}) = _$_FamilyDTO;
  const _FamilyDTO._() : super._();

  factory _FamilyDTO.fromJson(Map<String, dynamic> json) =
      _$_FamilyDTO.fromJson;
