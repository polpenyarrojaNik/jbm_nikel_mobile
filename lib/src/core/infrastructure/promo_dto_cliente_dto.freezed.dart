...
mixin _$PromoDtoClienteDTO {
  ...
  $PromoDtoClienteDTOCopyWith<PromoDtoClienteDTO> get copyWith =>
...
/// @nodoc
class _$PromoDtoClienteDTOCopyWithImpl<$Res, $Val extends PromoDtoClienteDTO>
    implements $PromoDtoClienteDTOCopyWith<$Res> {
  _$PromoDtoClienteDTOCopyWithImpl(this._value, this._then);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$PromoDtoClienteDTOImpl &&
...
abstract class _PromoDtoClienteDTO extends PromoDtoClienteDTO {
  ...
  factory _PromoDtoClienteDTO.fromJson(Map<String, dynamic> json) =
      _$PromoDtoClienteDTOImpl.fromJson;
