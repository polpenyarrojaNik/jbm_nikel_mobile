...
FamiliaDTO _$FamiliaDTOFromJson(Map<String, dynamic> json) {
  return _FamiliaDTO.fromJson(json);
}
...
/// @nodoc
abstract class $FamiliaDTOCopyWith<$Res> {
  factory $FamiliaDTOCopyWith(
          FamiliaDTO value, $Res Function(FamiliaDTO) then) =
      _$FamiliaDTOCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$FamiliaDTOCopyWithImpl<$Res> implements $FamiliaDTOCopyWith<$Res> {
  _$FamiliaDTOCopyWithImpl(this._value, this._then);

  final FamiliaDTO _value;
  // ignore: unused_field
...
/// @nodoc
class __$$_FamiliaDTOCopyWithImpl<$Res> extends _$FamiliaDTOCopyWithImpl<$Res>
    implements _$$_FamiliaDTOCopyWith<$Res> {
  __$$_FamiliaDTOCopyWithImpl(
      _$_FamiliaDTO _value, $Res Function(_$_FamiliaDTO) _then)
      : super(_value, (v) => _then(v as _$_FamiliaDTO));

  @override
  _$_FamiliaDTO get _value => super._value as _$_FamiliaDTO;
...
abstract class _FamiliaDTO extends FamiliaDTO {
  const factory _FamiliaDTO(
