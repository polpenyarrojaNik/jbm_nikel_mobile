...
_SyncDateTimeDTO _$SyncDateTimeDTOFromJson(Map<String, dynamic> json) =>
    _SyncDateTimeDTO(
      id: (json['ID'] as num).toInt(),
      dbSchemaVersion: (json['DB_SCHEMA_VERSION'] as num).toInt(),
      articuloUltimaSync: DateTime.parse(
        json['ARTICULO_ULTIMA_SYNC'] as String,
      ),
...
Map<String, dynamic> _$SyncDateTimeDTOToJson(_SyncDateTimeDTO instance) =>
    <String, dynamic>{
      'ID': instance.id,
