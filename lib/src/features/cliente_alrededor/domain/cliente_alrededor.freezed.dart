...
bool operator ==(Object other) {
  final _this = this as ClienteAlrededor;
...
int get hashCode {
  final _this = this as ClienteAlrededor;
  return Object.hashAll([runtimeType,_this.clienteId,_this.markerId,_this.nombre,_this.isDireccionFiscal,_this.direccion,_this.codigoPostal,_this.poblacion,_this.provincia,_this.pais,_this.isClientePotencial,_this.latitud,_this.longitud,_this.ventasAnyoActual,_this.ventasAnyoAnterior,_this.porcentajeAbonos,_this.nombreRepresentante1,_this.nombreRepresentante2,_this.ventasPeriodoActual,_this.ventasPeriodoAnterior,_this.bloqueoOper,_this.obsoleto]);
}

@override
String toString() {
  final _this = this as ClienteAlrededor;
  return 'ClienteAlrededor(clienteId: ${_this.clienteId}, markerId: ${_this.markerId}, nombre: ${_this.nombre}, isDireccionFiscal: ${_this.isDireccionFiscal}, direccion: ${_this.direccion}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, pais: ${_this.pais}, isClientePotencial: ${_this.isClientePotencial}, latitud: ${_this.latitud}, longitud: ${_this.longitud}, ventasAnyoActual: ${_this.ventasAnyoActual}, ventasAnyoAnterior: ${_this.ventasAnyoAnterior}, porcentajeAbonos: ${_this.porcentajeAbonos}, nombreRepresentante1: ${_this.nombreRepresentante1}, nombreRepresentante2: ${_this.nombreRepresentante2}, ventasPeriodoActual: ${_this.ventasPeriodoActual}, ventasPeriodoAnterior: ${_this.ventasPeriodoAnterior}, bloqueoOper: ${_this.bloqueoOper}, obsoleto: ${_this.obsoleto})';
}
...
as String?,ventasPeriodoActual: freezed == ventasPeriodoActual ? _self.ventasPeriodoActual : ventasPeriodoActual // ignore: cast_nullable_to_non_nullable
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,clienteId,markerId,nombre,isDireccionFiscal,direccion,codigoPostal,poblacion,provincia,pais,isClientePotencial,latitud,longitud,ventasAnyoActual,ventasAnyoAnterior,porcentajeAbonos,nombreRepresentante1,nombreRepresentante2,ventasPeriodoActual,ventasPeriodoAnterior,bloqueoOper,obsoleto]);
}

@override
String toString() {
    return 'ClienteAlrededor(clienteId: $clienteId, markerId: $markerId, nombre: $nombre, isDireccionFiscal: $isDireccionFiscal, direccion: $direccion, codigoPostal: $codigoPostal, poblacion: $poblacion, provincia: $provincia, pais: $pais, isClientePotencial: $isClientePotencial, latitud: $latitud, longitud: $longitud, ventasAnyoActual: $ventasAnyoActual, ventasAnyoAnterior: $ventasAnyoAnterior, porcentajeAbonos: $porcentajeAbonos, nombreRepresentante1: $nombreRepresentante1, nombreRepresentante2: $nombreRepresentante2, ventasPeriodoActual: $ventasPeriodoActual, ventasPeriodoAnterior: $ventasPeriodoAnterior, bloqueoOper: $bloqueoOper, obsoleto: $obsoleto)';
}
