...
int get hashCode {
  final _this = this as ClienteDireccion;
  return Object.hashAll([runtimeType,_this.clienteId,_this.direccionId,_this.direccionImpGuid,_this.nombre,_this.direccion1,_this.direccion2,_this.codigoPostal,_this.poblacion,_this.provincia,_this.pais,_this.telefono,_this.latitud,_this.longitud,_this.predeterminada,_this.lastUpdated,_this.enviada,_this.tratada,_this.deleted,_this.isManual]);
}

@override
String toString() {
  final _this = this as ClienteDireccion;
  return 'ClienteDireccion(clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, direccionImpGuid: ${_this.direccionImpGuid}, nombre: ${_this.nombre}, direccion1: ${_this.direccion1}, direccion2: ${_this.direccion2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, pais: ${_this.pais}, telefono: ${_this.telefono}, latitud: ${_this.latitud}, longitud: ${_this.longitud}, predeterminada: ${_this.predeterminada}, lastUpdated: ${_this.lastUpdated}, enviada: ${_this.enviada}, tratada: ${_this.tratada}, deleted: ${_this.deleted}, isManual: ${_this.isManual})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,clienteId,direccionId,direccionImpGuid,nombre,direccion1,direccion2,codigoPostal,poblacion,provincia,pais,telefono,latitud,longitud,predeterminada,lastUpdated,enviada,tratada,deleted,isManual]);
}
