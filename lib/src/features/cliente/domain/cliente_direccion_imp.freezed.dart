...
bool operator ==(Object other) {
  final _this = this as ClienteDireccionImp;
...
int get hashCode {
  final _this = this as ClienteDireccionImp;
  return Object.hash(runtimeType,_this.id,_this.fecha,_this.usuarioId,_this.clienteId,_this.direccionId,_this.nombre,_this.direccion1,_this.direccion2,_this.codigoPostal,_this.poblacion,_this.provincia,_this.telefono,_this.pais,_this.enviada,_this.borrar);
}

@override
String toString() {
  final _this = this as ClienteDireccionImp;
  return 'ClienteDireccionImp(id: ${_this.id}, fecha: ${_this.fecha}, usuarioId: ${_this.usuarioId}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombre: ${_this.nombre}, direccion1: ${_this.direccion1}, direccion2: ${_this.direccion2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, telefono: ${_this.telefono}, pais: ${_this.pais}, enviada: ${_this.enviada}, borrar: ${_this.borrar})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? fecha = null,Object? usuarioId = null,Object? clienteId = null,Object? direccionId = freezed,Object? nombre = freezed,Object? direccion1 = freezed,Object? direccion2 = freezed,Object? codigoPostal = freezed,Object? poblacion = freezed,Object? provincia = freezed,Object? telefono = freezed,Object? pais = freezed,Object? enviada = null,Object? borrar = null,}) {
  return _then(ClienteDireccionImp(
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,fecha,usuarioId,clienteId,direccionId,nombre,direccion1,direccion2,codigoPostal,poblacion,provincia,telefono,pais,enviada,borrar);
}
