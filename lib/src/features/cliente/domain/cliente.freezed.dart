...
bool operator ==(Object other) {
  ...
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Cliente&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.nombreCliente, _this.nombreCliente) || other.nombreCliente == _this.nombreCliente)&&(identical(other.nombreFiscal, _this.nombreFiscal) || other.nombreFiscal == _this.nombreFiscal)&&(identical(other.nif, _this.nif) || other.nif == _this.nif)&&(identical(other.direccionFiscal1, _this.direccionFiscal1) || other.direccionFiscal1 == _this.direccionFiscal1)&&(identical(other.direccionFiscal2, _this.direccionFiscal2) || other.direccionFiscal2 == _this.direccionFiscal2)&&(identical(other.codigoPostalFiscal, _this.codigoPostalFiscal) || other.codigoPostalFiscal == _this.codigoPostalFiscal)&&(identical(other.poblacionFiscal, _this.poblacionFiscal) || other.poblacionFiscal == _this.poblacionFiscal)&&(identical(other.provinciaFiscal, _this.provinciaFiscal) || other.provinciaFiscal == _this.provinciaFiscal)&&(identical(other.paisFiscal, _this.paisFiscal) || other.paisFiscal == _this.paisFiscal)&&(identical(other.latitudFiscal, _this.latitudFiscal) || other.latitudFiscal == _this.latitudFiscal)&&(identical(other.longitudFiscal, _this.longitudFiscal) || other.longitudFiscal == _this.longitudFiscal)&&(identical(other.direccionPredeterminada1, _this.direccionPredeterminada1) || other.direccionPredeterminada1 == _this.direccionPredeterminada1)&&(identical(other.direccionPredeterminada2, _this.direccionPredeterminada2) || other.direccionPredeterminada2 == _this.direccionPredeterminada2)&&(identical(other.codigoPostalPredeterminada, _this.codigoPostalPredeterminada) || other.codigoPostalPredeterminada == _this.codigoPostalPredeterminada)&&(identical(other.poblacionPredeterminada, _this.poblacionPredeterminada) || other.poblacionPredeterminada == _this.poblacionPredeterminada)&&(identical(other.provinciaPredeterminada, _this.provinciaPredeterminada) || other.provinciaPredeterminada == _this.provinciaPredeterminada)&&(identical(other.paisPredeterminada, _this.paisPredeterminada) || other.paisPredeterminada == _this.paisPredeterminada)&&(identical(other.latitudPredeterminada, _this.latitudPredeterminada) || other.latitudPredeterminada == _this.latitudPredeterminada)&&(identical(other.longitudPredeterminada, _this.longitudPredeterminada) || other.longitudPredeterminada == _this.longitudPredeterminada)&&(identical(other.empresaId, _this.empresaId) || other.empresaId == _this.empresaId)&&(identical(other.iva, _this.iva) || other.iva == _this.iva)&&(identical(other.ventasAnyoActual, _this.ventasAnyoActual) || other.ventasAnyoActual == _this.ventasAnyoActual)&&(identical(other.ventasAnyoAnterior, _this.ventasAnyoAnterior) || other.ventasAnyoAnterior == _this.ventasAnyoAnterior)&&(identical(other.ventasHaceDosAnyos, _this.ventasHaceDosAnyos) || other.ventasHaceDosAnyos == _this.ventasHaceDosAnyos)&&(identical(other.margenAnyoActual, _this.margenAnyoActual) || other.margenAnyoActual == _this.margenAnyoActual)&&(identical(other.margenAnyoAnterior, _this.margenAnyoAnterior) || other.margenAnyoAnterior == _this.margenAnyoAnterior)&&(identical(other.margenHaceDosAnyos, _this.margenHaceDosAnyos) || other.margenHaceDosAnyos == _this.margenHaceDosAnyos)&&(identical(other.porcentajeAbonos, _this.porcentajeAbonos) || other.porcentajeAbonos == _this.porcentajeAbonos)&&(identical(other.porcentajeGarantias, _this.porcentajeGarantias) || other.porcentajeGarantias == _this.porcentajeGarantias)&&(identical(other.centralCompras, _this.centralCompras) || other.centralCompras == _this.centralCompras)&&(identical(other.urlWeb, _this.urlWeb) || other.urlWeb == _this.urlWeb)&&(identical(other.divisa, _this.divisa) || other.divisa == _this.divisa)&&(identical(other.tarifaId, _this.tarifaId) || other.tarifaId == _this.tarifaId)&&(identical(other.tarifaDescripcion, _this.tarifaDescripcion) || other.tarifaDescripcion == _this.tarifaDescripcion)&&(identical(other.descuentoGeneralId, _this.descuentoGeneralId) || other.descuentoGeneralId == _this.descuentoGeneralId)&&(identical(other.descripcionDescuentoGeneral, _this.descripcionDescuentoGeneral) || other.descripcionDescuentoGeneral == _this.descripcionDescuentoGeneral)&&(identical(other.tipoCalculoPrecio, _this.tipoCalculoPrecio) || other.tipoCalculoPrecio == _this.tipoCalculoPrecio)&&(identical(other.plazoDeCobro, _this.plazoDeCobro) || other.plazoDeCobro == _this.plazoDeCobro)&&(identical(other.metodoDeCobro, _this.metodoDeCobro) || other.metodoDeCobro == _this.metodoDeCobro)&&(identical(other.descuentoProntoPago, _this.descuentoProntoPago) || other.descuentoProntoPago == _this.descuentoProntoPago)&&(identical(other.riesgoConcedidoInterno, _this.riesgoConcedidoInterno) || other.riesgoConcedidoInterno == _this.riesgoConcedidoInterno)&&(identical(other.riesgoConcedidoInternoDate, _this.riesgoConcedidoInternoDate) || other.riesgoConcedidoInternoDate == _this.riesgoConcedidoInternoDate)&&(identical(other.riesgoConcedidoCoafe, _this.riesgoConcedidoCoafe) || other.riesgoConcedidoCoafe == _this.riesgoConcedidoCoafe)&&(identical(other.riesgoConcedidoCoafeFecha, _this.riesgoConcedidoCoafeFecha) || other.riesgoConcedidoCoafeFecha == _this.riesgoConcedidoCoafeFecha)&&(identical(other.riesgoActual, _this.riesgoActual) || other.riesgoActual == _this.riesgoActual)&&(identical(other.riesgoConcedido, _this.riesgoConcedido) || other.riesgoConcedido == _this.riesgoConcedido)&&(identical(other.riesgoPendienteCobroVencido, _this.riesgoPendienteCobroVencido) || other.riesgoPendienteCobroVencido == _this.riesgoPendienteCobroVencido)&&(identical(other.riesgoPendienteCobroNoVencido, _this.riesgoPendienteCobroNoVencido) || other.riesgoPendienteCobroNoVencido == _this.riesgoPendienteCobroNoVencido)&&(identical(other.riesgoPendienteServir, _this.riesgoPendienteServir) || other.riesgoPendienteServir == _this.riesgoPendienteServir)&&(identical(other.riesgoPendienteFacturar, _this.riesgoPendienteFacturar) || other.riesgoPendienteFacturar == _this.riesgoPendienteFacturar)&&(identical(other.riesgoExcedido, _this.riesgoExcedido) || other.riesgoExcedido == _this.riesgoExcedido)&&(identical(other.obvservacionesInternas, _this.obvservacionesInternas) || other.obvservacionesInternas == _this.obvservacionesInternas)&&(identical(other.clientePotencial, _this.clientePotencial) || other.clientePotencial == _this.clientePotencial)&&(identical(other.clienteEstadoPotencial, _this.clienteEstadoPotencial) || other.clienteEstadoPotencial == _this.clienteEstadoPotencial)&&(identical(other.clienteTipoPotencial, _this.clienteTipoPotencial) || other.clienteTipoPotencial == _this.clienteTipoPotencial)&&(identical(other.representante1Id, _this.representante1Id) || other.representante1Id == _this.representante1Id)&&(identical(other.representante1Nombre, _this.representante1Nombre) || other.representante1Nombre == _this.representante1Nombre)&&(identical(other.representante2Id, _this.representante2Id) || other.representante2Id == _this.representante2Id)&&(identical(other.representante2Nombre, _this.representante2Nombre) || other.representante2Nombre == _this.representante2Nombre)&&(identical(other.telefonoMovil, _this.telefonoMovil) || other.telefonoMovil == _this.telefonoMovil)&&(identical(other.telefonoFijo, _this.telefonoFijo) || other.telefonoFijo == _this.telefonoFijo)&&(identical(other.email, _this.email) || other.email == _this.email)&&(identical(other.sector, _this.sector) || other.sector == _this.sector)&&(identical(other.subsector, _this.subsector) || other.subsector == _this.subsector)&&(identical(other.franqPortes1, _this.franqPortes1) || other.franqPortes1 == _this.franqPortes1)&&(identical(other.franqPortes2, _this.franqPortes2) || other.franqPortes2 == _this.franqPortes2)&&(identical(other.franqPortes3, _this.franqPortes3) || other.franqPortes3 == _this.franqPortes3)&&(identical(other.importePortes1, _this.importePortes1) || other.importePortes1 == _this.importePortes1)&&(identical(other.importePortes2, _this.importePortes2) || other.importePortes2 == _this.importePortes2)&&(identical(other.importePortes3, _this.importePortes3) || other.importePortes3 == _this.importePortes3)&&(identical(other.ventasPeriodoActual, _this.ventasPeriodoActual) || other.ventasPeriodoActual == _this.ventasPeriodoActual)&&(identical(other.ventasPeriodoAnterior, _this.ventasPeriodoAnterior) || other.ventasPeriodoAnterior == _this.ventasPeriodoAnterior)&&(identical(other.bloqueoOper, _this.bloqueoOper) || other.bloqueoOper == _this.bloqueoOper)&&(identical(other.obsoleto, _this.obsoleto) || other.obsoleto == _this.obsoleto)&&(identical(other.lastUpdated, _this.lastUpdated) || other.lastUpdated == _this.lastUpdated)&&(identical(other.deleted, _this.deleted) || other.deleted == _this.deleted));
}
...
int get hashCode {
  final _this = this as Cliente;
  return Object.hashAll([runtimeType,_this.id,_this.nombreCliente,_this.nombreFiscal,_this.nif,_this.direccionFiscal1,_this.direccionFiscal2,_this.codigoPostalFiscal,_this.poblacionFiscal,_this.provinciaFiscal,_this.paisFiscal,_this.latitudFiscal,_this.longitudFiscal,_this.direccionPredeterminada1,_this.direccionPredeterminada2,_this.codigoPostalPredeterminada,_this.poblacionPredeterminada,_this.provinciaPredeterminada,_this.paisPredeterminada,_this.latitudPredeterminada,_this.longitudPredeterminada,_this.empresaId,_this.iva,_this.ventasAnyoActual,_this.ventasAnyoAnterior,_this.ventasHaceDosAnyos,_this.margenAnyoActual,_this.margenAnyoAnterior,_this.margenHaceDosAnyos,_this.porcentajeAbonos,_this.porcentajeGarantias,_this.centralCompras,_this.urlWeb,_this.divisa,_this.tarifaId,_this.tarifaDescripcion,_this.descuentoGeneralId,_this.descripcionDescuentoGeneral,_this.tipoCalculoPrecio,_this.plazoDeCobro,_this.metodoDeCobro,_this.descuentoProntoPago,_this.riesgoConcedidoInterno,_this.riesgoConcedidoInternoDate,_this.riesgoConcedidoCoafe,_this.riesgoConcedidoCoafeFecha,_this.riesgoActual,_this.riesgoConcedido,_this.riesgoPendienteCobroVencido,_this.riesgoPendienteCobroNoVencido,_this.riesgoPendienteServir,_this.riesgoPendienteFacturar,_this.riesgoExcedido,_this.obvservacionesInternas,_this.clientePotencial,_this.clienteEstadoPotencial,_this.clienteTipoPotencial,_this.representante1Id,_this.representante1Nombre,_this.representante2Id,_this.representante2Nombre,_this.telefonoMovil,_this.telefonoFijo,_this.email,_this.sector,_this.subsector,_this.franqPortes1,_this.franqPortes2,_this.franqPortes3,_this.importePortes1,_this.importePortes2,_this.importePortes3,_this.ventasPeriodoActual,_this.ventasPeriodoAnterior,_this.bloqueoOper,_this.obsoleto,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as Cliente;
  return 'Cliente(id: ${_this.id}, nombreCliente: ${_this.nombreCliente}, nombreFiscal: ${_this.nombreFiscal}, nif: ${_this.nif}, direccionFiscal1: ${_this.direccionFiscal1}, direccionFiscal2: ${_this.direccionFiscal2}, codigoPostalFiscal: ${_this.codigoPostalFiscal}, poblacionFiscal: ${_this.poblacionFiscal}, provinciaFiscal: ${_this.provinciaFiscal}, paisFiscal: ${_this.paisFiscal}, latitudFiscal: ${_this.latitudFiscal}, longitudFiscal: ${_this.longitudFiscal}, direccionPredeterminada1: ${_this.direccionPredeterminada1}, direccionPredeterminada2: ${_this.direccionPredeterminada2}, codigoPostalPredeterminada: ${_this.codigoPostalPredeterminada}, poblacionPredeterminada: ${_this.poblacionPredeterminada}, provinciaPredeterminada: ${_this.provinciaPredeterminada}, paisPredeterminada: ${_this.paisPredeterminada}, latitudPredeterminada: ${_this.latitudPredeterminada}, longitudPredeterminada: ${_this.longitudPredeterminada}, empresaId: ${_this.empresaId}, iva: ${_this.iva}, ventasAnyoActual: ${_this.ventasAnyoActual}, ventasAnyoAnterior: ${_this.ventasAnyoAnterior}, ventasHaceDosAnyos: ${_this.ventasHaceDosAnyos}, margenAnyoActual: ${_this.margenAnyoActual}, margenAnyoAnterior: ${_this.margenAnyoAnterior}, margenHaceDosAnyos: ${_this.margenHaceDosAnyos}, porcentajeAbonos: ${_this.porcentajeAbonos}, porcentajeGarantias: ${_this.porcentajeGarantias}, centralCompras: ${_this.centralCompras}, urlWeb: ${_this.urlWeb}, divisa: ${_this.divisa}, tarifaId: ${_this.tarifaId}, tarifaDescripcion: ${_this.tarifaDescripcion}, descuentoGeneralId: ${_this.descuentoGeneralId}, descripcionDescuentoGeneral: ${_this.descripcionDescuentoGeneral}, tipoCalculoPrecio: ${_this.tipoCalculoPrecio}, plazoDeCobro: ${_this.plazoDeCobro}, metodoDeCobro: ${_this.metodoDeCobro}, descuentoProntoPago: ${_this.descuentoProntoPago}, riesgoConcedidoInterno: ${_this.riesgoConcedidoInterno}, riesgoConcedidoInternoDate: ${_this.riesgoConcedidoInternoDate}, riesgoConcedidoCoafe: ${_this.riesgoConcedidoCoafe}, riesgoConcedidoCoafeFecha: ${_this.riesgoConcedidoCoafeFecha}, riesgoActual: ${_this.riesgoActual}, riesgoConcedido: ${_this.riesgoConcedido}, riesgoPendienteCobroVencido: ${_this.riesgoPendienteCobroVencido}, riesgoPendienteCobroNoVencido: ${_this.riesgoPendienteCobroNoVencido}, riesgoPendienteServir: ${_this.riesgoPendienteServir}, riesgoPendienteFacturar: ${_this.riesgoPendienteFacturar}, riesgoExcedido: ${_this.riesgoExcedido}, obvservacionesInternas: ${_this.obvservacionesInternas}, clientePotencial: ${_this.clientePotencial}, clienteEstadoPotencial: ${_this.clienteEstadoPotencial}, clienteTipoPotencial: ${_this.clienteTipoPotencial}, representante1Id: ${_this.representante1Id}, representante1Nombre: ${_this.representante1Nombre}, representante2Id: ${_this.representante2Id}, representante2Nombre: ${_this.representante2Nombre}, telefonoMovil: ${_this.telefonoMovil}, telefonoFijo: ${_this.telefonoFijo}, email: ${_this.email}, sector: ${_this.sector}, subsector: ${_this.subsector}, franqPortes1: ${_this.franqPortes1}, franqPortes2: ${_this.franqPortes2}, franqPortes3: ${_this.franqPortes3}, importePortes1: ${_this.importePortes1}, importePortes2: ${_this.importePortes2}, importePortes3: ${_this.importePortes3}, ventasPeriodoActual: ${_this.ventasPeriodoActual}, ventasPeriodoAnterior: ${_this.ventasPeriodoAnterior}, bloqueoOper: ${_this.bloqueoOper}, obsoleto: ${_this.obsoleto}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String nombreCliente,  String nombreFiscal,  String? nif,  String? direccionFiscal1,  String? direccionFiscal2,  String? codigoPostalFiscal,  String? poblacionFiscal,  String? provinciaFiscal,  Pais? paisFiscal,  double latitudFiscal,  double longitudFiscal,  String? direccionPredeterminada1,  String? direccionPredeterminada2,  String? codigoPostalPredeterminada,  String? poblacionPredeterminada,  String? provinciaPredeterminada,  Pais? paisPredeterminada,  double? latitudPredeterminada,  double? longitudPredeterminada,  String empresaId,  double iva,  Money ventasAnyoActual,  Money ventasAnyoAnterior,  Money ventasHaceDosAnyos,  double margenAnyoActual,  double margenAnyoAnterior,  double margenHaceDosAnyos,  double porcentajeAbonos,  double porcentajeGarantias,  String? centralCompras,  String? urlWeb,  Divisa? divisa,  String? tarifaId,  String? tarifaDescripcion,  String? descuentoGeneralId,  String? descripcionDescuentoGeneral,  String tipoCalculoPrecio,  PlazoDeCobro? plazoDeCobro,  MetodoDeCobro? metodoDeCobro,  double descuentoProntoPago,  Money riesgoConcedidoInterno,  DateTime? riesgoConcedidoInternoDate,  Money riesgoConcedidoCoafe,  DateTime? riesgoConcedidoCoafeFecha,  Money riesgoActual,  Money? riesgoConcedido,  Money? riesgoPendienteCobroVencido,  Money? riesgoPendienteCobroNoVencido,  Money? riesgoPendienteServir,  Money? riesgoPendienteFacturar,  Money riesgoExcedido,  String? obvservacionesInternas,  bool? clientePotencial,  ClienteEstadoPotencial? clienteEstadoPotencial,  ClienteTipoPotencial? clienteTipoPotencial,  String? representante1Id,  String? representante1Nombre,  String? representante2Id,  String? representante2Nombre,  String? telefonoMovil,  String? telefonoFijo,  String? email,  Sector? sector,  Subsector? subsector,  int? franqPortes1,  int? franqPortes2,  int? franqPortes3,  double? importePortes1,  double? importePortes2,  double? importePortes3,  double? ventasPeriodoActual,  double? ventasPeriodoAnterior,  bool bloqueoOper,  bool obsoleto,  DateTime? lastUpdated,  bool deleted)  $default,) {final _that = this;
switch (_that) {
case _Cliente():
return $default(_that.id,_that.nombreCliente,_that.nombreFiscal,_that.nif,_that.direccionFiscal1,_that.direccionFiscal2,_that.codigoPostalFiscal,_that.poblacionFiscal,_that.provinciaFiscal,_that.paisFiscal,_that.latitudFiscal,_that.longitudFiscal,_that.direccionPredeterminada1,_that.direccionPredeterminada2,_that.codigoPostalPredeterminada,_that.poblacionPredeterminada,_that.provinciaPredeterminada,_that.paisPredeterminada,_that.latitudPredeterminada,_that.longitudPredeterminada,_that.empresaId,_that.iva,_that.ventasAnyoActual,_that.ventasAnyoAnterior,_that.ventasHaceDosAnyos,_that.margenAnyoActual,_that.margenAnyoAnterior,_that.margenHaceDosAnyos,_that.porcentajeAbonos,_that.porcentajeGarantias,_that.centralCompras,_that.urlWeb,_that.divisa,_that.tarifaId,_that.tarifaDescripcion,_that.descuentoGeneralId,_that.descripcionDescuentoGeneral,_that.tipoCalculoPrecio,_that.plazoDeCobro,_that.metodoDeCobro,_that.descuentoProntoPago,_that.riesgoConcedidoInterno,_that.riesgoConcedidoInternoDate,_that.riesgoConcedidoCoafe,_that.riesgoConcedidoCoafeFecha,_that.riesgoActual,_that.riesgoConcedido,_that.riesgoPendienteCobroVencido,_that.riesgoPendienteCobroNoVencido,_that.riesgoPendienteServir,_that.riesgoPendienteFacturar,_that.riesgoExcedido,_that.obvservacionesInternas,_that.clientePotencial,_that.clienteEstadoPotencial,_that.clienteTipoPotencial,_that.representante1Id,_that.representante1Nombre,_that.representante2Id,_that.representante2Nombre,_that.telefonoMovil,_that.telefonoFijo,_that.email,_that.sector,_that.subsector,_that.franqPortes1,_that.franqPortes2,_that.franqPortes3,_that.importePortes1,_that.importePortes2,_that.importePortes3,_that.ventasPeriodoActual,_that.ventasPeriodoAnterior,_that.bloqueoOper,_that.obsoleto,_that.lastUpdated,_that.deleted);case _:
  throw StateError('Unexpected subclass');
