...
class _$_ClienteContacto extends _ClienteContacto {
  ...
  @override
  String toString() {
    return 'ClienteContacto(clienteId: $clienteId, contactoId: $contactoId, observaciones: $observaciones, nombre: $nombre, telefono1: $telefono1, telefono2: $telefono2, email: $email, lastUpdated: $lastUpdated, deleted: $deleted)';
  }
