...
abstract class $ClienteDireccionImpDTOCopyWith<$Res> {
  factory $ClienteDireccionImpDTOCopyWith(
    ClienteDireccionImpDTO value,
...
/// @nodoc
class _$ClienteDireccionImpDTOCopyWithImpl<
  $Res,
...
class __$$ClienteDireccionImpDTOImplCopyWithImpl<$Res>
    extends
        _$ClienteDireccionImpDTOCopyWithImpl<$Res, _$ClienteDireccionImpDTOImpl>
...
class _$ClienteDireccionImpDTOImpl extends _ClienteDireccionImpDTO {
  ...
  get copyWith =>
      __$$ClienteDireccionImpDTOImplCopyWithImpl<_$ClienteDireccionImpDTOImpl>(
        this,
        _$identity,
      );
  ...
  Map<String, dynamic> toJson() {
    return _$$ClienteDireccionImpDTOImplToJson(this);
  }
}
...
abstract class _ClienteDireccionImpDTO extends ClienteDireccionImpDTO {
  const factory _ClienteDireccionImpDTO({
    ...
    @JsonKey(name: 'ENVIADA', defaultValue: 'N') required final String enviada,
