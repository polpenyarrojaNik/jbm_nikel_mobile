...
String toString() {
  final _this = this as PlazoDeCobroDTO;
  return 'PlazoDeCobroDTO(id: ${_this.id}, descripcionES: ${_this.descripcionES}, descripcionEN: ${_this.descripcionEN}, descripcionFR: ${_this.descripcionFR}, descripcionDE: ${_this.descripcionDE}, descripcionCA: ${_this.descripcionCA}, descripcionGB: ${_this.descripcionGB}, descripcionHU: ${_this.descripcionHU}, descripcionIT: ${_this.descripcionIT}, descripcionNL: ${_this.descripcionNL}, descripcionPL: ${_this.descripcionPL}, descripcionPT: ${_this.descripcionPT}, descripcionRO: ${_this.descripcionRO}, descripcionRU: ${_this.descripcionRU}, descripcionCN: ${_this.descripcionCN}, descripcionEL: ${_this.descripcionEL}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
/// @nodoc
class _$PlazoDeCobroDTOCopyWithImpl<$Res>
    implements $PlazoDeCobroDTOCopyWith<$Res> {
  _$PlazoDeCobroDTOCopyWithImpl(this._self, this._then);

  final PlazoDeCobroDTO _self;
  final $Res Function(PlazoDeCobroDTO) _then;
...
/// Adds pattern-matching-related methods to [PlazoDeCobroDTO].
extension PlazoDeCobroDTOPatterns on PlazoDeCobroDTO {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _PlazoDeCobroDTO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _PlazoDeCobroDTO() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _PlazoDeCobroDTO value)  $default,){
final _that = this;
switch (_that) {
case _PlazoDeCobroDTO():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _PlazoDeCobroDTO value)?  $default,){
final _that = this;
switch (_that) {
case _PlazoDeCobroDTO() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'PLAZO_COBRO_ID')  String id, @JsonKey(name: 'DESCRIPCION_ES')  String descripcionES, @JsonKey(name: 'DESCRIPCION_EN')  String? descripcionEN, @JsonKey(name: 'DESCRIPCION_FR')  String? descripcionFR, @JsonKey(name: 'DESCRIPCION_DE')  String? descripcionDE, @JsonKey(name: 'DESCRIPCION_CA')  String? descripcionCA, @JsonKey(name: 'DESCRIPCION_GB')  String? descripcionGB, @JsonKey(name: 'DESCRIPCION_HU')  String? descripcionHU, @JsonKey(name: 'DESCRIPCION_IT')  String? descripcionIT, @JsonKey(name: 'DESCRIPCION_NL')  String? descripcionNL, @JsonKey(name: 'DESCRIPCION_PL')  String? descripcionPL, @JsonKey(name: 'DESCRIPCION_PT')  String? descripcionPT, @JsonKey(name: 'DESCRIPCION_RO')  String? descripcionRO, @JsonKey(name: 'DESCRIPCION_RU')  String? descripcionRU, @JsonKey(name: 'DESCRIPCION_CN')  String? descripcionCN, @JsonKey(name: 'DESCRIPCION_EL')  String? descripcionEL, @JsonKey(name: 'LAST_UPDATED')  DateTime lastUpdated, @JsonKey(name: 'DELETED')  String deleted)?  $default,) {final _that = this;
switch (_that) {
case _PlazoDeCobroDTO() when $default != null:
return $default(_that.id,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL,_that.descripcionPT,_that.descripcionRO,_that.descripcionRU,_that.descripcionCN,_that.descripcionEL,_that.lastUpdated,_that.deleted);case _:
  return null;
...
@override
String toString() {
    return 'PlazoDeCobroDTO(id: $id, descripcionES: $descripcionES, descripcionEN: $descripcionEN, descripcionFR: $descripcionFR, descripcionDE: $descripcionDE, descripcionCA: $descripcionCA, descripcionGB: $descripcionGB, descripcionHU: $descripcionHU, descripcionIT: $descripcionIT, descripcionNL: $descripcionNL, descripcionPL: $descripcionPL, descripcionPT: $descripcionPT, descripcionRO: $descripcionRO, descripcionRU: $descripcionRU, descripcionCN: $descripcionCN, descripcionEL: $descripcionEL, lastUpdated: $lastUpdated, deleted: $deleted)';
}
...
/// @nodoc
abstract mixin class _$PlazoDeCobroDTOCopyWith<$Res> implements $PlazoDeCobroDTOCopyWith<$Res> {
  factory _$PlazoDeCobroDTOCopyWith(_PlazoDeCobroDTO value, $Res Function(_PlazoDeCobroDTO) _then) = __$PlazoDeCobroDTOCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'PLAZO_COBRO_ID') String id,@JsonKey(name: 'DESCRIPCION_ES') String descripcionES,@JsonKey(name: 'DESCRIPCION_EN') String? descripcionEN,@JsonKey(name: 'DESCRIPCION_FR') String? descripcionFR,@JsonKey(name: 'DESCRIPCION_DE') String? descripcionDE,@JsonKey(name: 'DESCRIPCION_CA') String? descripcionCA,@JsonKey(name: 'DESCRIPCION_GB') String? descripcionGB,@JsonKey(name: 'DESCRIPCION_HU') String? descripcionHU,@JsonKey(name: 'DESCRIPCION_IT') String? descripcionIT,@JsonKey(name: 'DESCRIPCION_NL') String? descripcionNL,@JsonKey(name: 'DESCRIPCION_PL') String? descripcionPL,@JsonKey(name: 'DESCRIPCION_PT') String? descripcionPT,@JsonKey(name: 'DESCRIPCION_RO') String? descripcionRO,@JsonKey(name: 'DESCRIPCION_RU') String? descripcionRU,@JsonKey(name: 'DESCRIPCION_CN') String? descripcionCN,@JsonKey(name: 'DESCRIPCION_EL') String? descripcionEL,@JsonKey(name: 'LAST_UPDATED') DateTime lastUpdated,@JsonKey(name: 'DELETED') String deleted
});
...
/// @nodoc
class __$PlazoDeCobroDTOCopyWithImpl<$Res>
    implements _$PlazoDeCobroDTOCopyWith<$Res> {
  __$PlazoDeCobroDTOCopyWithImpl(this._self, this._then);

  final _PlazoDeCobroDTO _self;
  final $Res Function(_PlazoDeCobroDTO) _then;

/// Create a copy of PlazoDeCobroDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? descripcionES = null,Object? descripcionEN = freezed,Object? descripcionFR = freezed,Object? descripcionDE = freezed,Object? descripcionCA = freezed,Object? descripcionGB = freezed,Object? descripcionHU = freezed,Object? descripcionIT = freezed,Object? descripcionNL = freezed,Object? descripcionPL = freezed,Object? descripcionPT = freezed,Object? descripcionRO = freezed,Object? descripcionRU = freezed,Object? descripcionCN = freezed,Object? descripcionEL = freezed,Object? lastUpdated = null,Object? deleted = null,}) {
  return _then(_PlazoDeCobroDTO(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as String,descripcionES: null == descripcionES ? _self.descripcionES : descripcionES // ignore: cast_nullable_to_non_nullable
as String,descripcionEN: freezed == descripcionEN ? _self.descripcionEN : descripcionEN // ignore: cast_nullable_to_non_nullable
as String?,descripcionFR: freezed == descripcionFR ? _self.descripcionFR : descripcionFR // ignore: cast_nullable_to_non_nullable
