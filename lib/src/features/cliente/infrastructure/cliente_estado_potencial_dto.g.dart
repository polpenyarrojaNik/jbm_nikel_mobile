...
_ClienteEstadoPotencialDTO _$ClienteEstadoPotencialDTOFromJson(
  Map<String, dynamic> json,
) => _ClienteEstadoPotencialDTO(
  id: json['ESTADO_POTENCIAL_ID'] as String,
...
Map<String, dynamic> _$ClienteEstadoPotencialDTOToJson(
  _ClienteEstadoPotencialDTO instance,
) => <String, dynamic>{
  'ESTADO_POTENCIAL_ID': instance.id,
