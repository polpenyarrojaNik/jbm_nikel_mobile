...
_$ClienteTipoPotencialDTOImpl _$$ClienteTipoPotencialDTOImplFromJson(
...
Map<String, dynamic> _$$ClienteTipoPotencialDTOImplToJson(
        _$ClienteTipoPotencialDTOImpl instance) =>
    <String, dynamic>{
      'TIPO_POTENCIAL_ID': instance.id,
