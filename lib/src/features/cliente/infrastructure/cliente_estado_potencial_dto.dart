...
part 'cliente_estado_potencial_dto.g.dart';
...
class ClienteEstadoPotencialDTO
  ...
  const factory ClienteEstadoPotencialDTO({
    @JsonKey(name: 'ESTADO_POTENCIAL_ID') required String id,
  ...
  }) = _ClienteEstadoPotencialDTO;

  factory ClienteEstadoPotencialDTO.fromJson(Map<String, dynamic> json) =>
      _$ClienteEstadoPotencialDTOFromJson(json);

  ClienteEstadoPotencial toDomain() {
    return ClienteEstadoPotencial(
        id: id,
...
@UseRowClass(ClienteEstadoPotencialDTO)
class ClienteEstadoPotencialTable extends Table {
  @override
  String get tableName => 'CLIENTES_ESTADOS_POTENCIAL';

  @override
  Set<Column> get primaryKey => {id};

  TextColumn get id => text().named('ESTADO_POTENCIAL_ID')();
