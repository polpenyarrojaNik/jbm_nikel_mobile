...
part 'cliente_tipo_potencial_dto.freezed.dart';
part 'cliente_tipo_potencial_dto.g.dart';

// ignore_for_file: invalid_annotation_target

@freezed
abstract class ClienteTipoPotencialDTO
    with _$ClienteTipoPotencialDTO
    implements Insertable<ClienteTipoPotencialDTO> {
  ...
  }) = _ClienteTipoPotencialDTO;

  factory ClienteTipoPotencialDTO.fromJson(Map<String, dynamic> json) =>
      _$ClienteTipoPotencialDTOFromJson(json);

  ClienteTipoPotencial toDomain() {
    return ClienteTipoPotencial(
      id: id,
...
@UseRowClass(ClienteTipoPotencialDTO)
class ClienteTipoPotencialTable extends Table {
  @override
  String get tableName => 'CLIENTES_TIPOS_POTENCIAL';
