...
bool operator ==(Object other) {
  final _this = this as ClienteDescuentoDTO;
...
int get hashCode {
  final _this = this as ClienteDescuentoDTO;
  return Object.hash(runtimeType,_this.clienteId,_this.articuloId,_this.familiaId,_this.subfamiliaId,_this.cantidadDesde,_this.descuento,_this.lastUpdated,_this.deleted);
}

@override
String toString() {
  final _this = this as ClienteDescuentoDTO;
  return 'ClienteDescuentoDTO(clienteId: ${_this.clienteId}, articuloId: ${_this.articuloId}, familiaId: ${_this.familiaId}, subfamiliaId: ${_this.subfamiliaId}, cantidadDesde: ${_this.cantidadDesde}, descuento: ${_this.descuento}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? clienteId = null,Object? articuloId = null,Object? familiaId = null,Object? subfamiliaId = null,Object? cantidadDesde = null,Object? descuento = null,Object? lastUpdated = null,Object? deleted = null,}) {
  return _then(ClienteDescuentoDTO(
...
@override
int get hashCode {
    return Object.hash(runtimeType,clienteId,articuloId,familiaId,subfamiliaId,cantidadDesde,descuento,lastUpdated,deleted);
}
