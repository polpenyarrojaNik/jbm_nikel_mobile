...
part 'plazo_cobro_dto.freezed.dart';
part 'plazo_cobro_dto.g.dart';
...
class PlazoDeCobroDTO
  ...
  factory PlazoDeCobroDTO.fromJson(Map<String, dynamic> json) =>
      _$PlazoDeCobroDTOFromJson(json);
...
@UseRowClass(PlazoDeCobroDTO)
class PlazoDeCobroTable extends Table {
  @override
