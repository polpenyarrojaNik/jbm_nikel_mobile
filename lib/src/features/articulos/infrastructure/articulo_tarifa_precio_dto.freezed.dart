...
ArticuloTarifaPrecioDTO _$ArticuloTarifaPrecioDTOFromJson(
    Map<String, dynamic> json) {
  return _ArticuloTarifaPrecioDTO.fromJson(json);
}

/// @nodoc
mixin _$ArticuloTarifaPrecioDTO {
  ...
  @JsonKey(ignore: true)
  $ArticuloTarifaPrecioDTOCopyWith<ArticuloTarifaPrecioDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $ArticuloTarifaPrecioDTOCopyWith<$Res> {
  factory $ArticuloTarifaPrecioDTOCopyWith(ArticuloTarifaPrecioDTO value,
          $Res Function(ArticuloTarifaPrecioDTO) then) =
      _$ArticuloTarifaPrecioDTOCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$ArticuloTarifaPrecioDTOCopyWithImpl<$Res>
    implements $ArticuloTarifaPrecioDTOCopyWith<$Res> {
  _$ArticuloTarifaPrecioDTOCopyWithImpl(this._value, this._then);

  final ArticuloTarifaPrecioDTO _value;
  // ignore: unused_field
  final $Res Function(ArticuloTarifaPrecioDTO) _then;
...
/// @nodoc
abstract class _$$_ArticuloTarifaPrecioDTOCopyWith<$Res>
    implements $ArticuloTarifaPrecioDTOCopyWith<$Res> {
  factory _$$_ArticuloTarifaPrecioDTOCopyWith(_$_ArticuloTarifaPrecioDTO value,
          $Res Function(_$_ArticuloTarifaPrecioDTO) then) =
      __$$_ArticuloTarifaPrecioDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'ARTICULO_ID') String articuloId,
      @JsonKey(name: 'TARIFA_ID') String tarifaId,
...
/// @nodoc
class __$$_ArticuloTarifaPrecioDTOCopyWithImpl<$Res>
    extends _$ArticuloTarifaPrecioDTOCopyWithImpl<$Res>
    implements _$$_ArticuloTarifaPrecioDTOCopyWith<$Res> {
  __$$_ArticuloTarifaPrecioDTOCopyWithImpl(_$_ArticuloTarifaPrecioDTO _value,
      $Res Function(_$_ArticuloTarifaPrecioDTO) _then)
      : super(_value, (v) => _then(v as _$_ArticuloTarifaPrecioDTO));

  @override
  _$_ArticuloTarifaPrecioDTO get _value =>
      super._value as _$_ArticuloTarifaPrecioDTO;
  ...
  $Res call({
    ...
    return _then(_$_ArticuloTarifaPrecioDTO(
      articuloId: articuloId == freezed
          ? _value.articuloId
          : articuloId // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_ArticuloTarifaPrecioDTO extends _ArticuloTarifaPrecioDTO {
  const _$_ArticuloTarifaPrecioDTO(
  ...
  factory _$_ArticuloTarifaPrecioDTO.fromJson(Map<String, dynamic> json) =>
      _$$_ArticuloTarifaPrecioDTOFromJson(json);
  ...
  @override
  String toString() {
    return 'ArticuloTarifaPrecioDTO(articuloId: $articuloId, tarifaId: $tarifaId, tarifaDescripcion: $tarifaDescripcion, cantidadDesDe: $cantidadDesDe, precio: $precio, tipoPrecio: $tipoPrecio, lastUpdated: $lastUpdated, deleted: $deleted)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_ArticuloTarifaPrecioDTO &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_ArticuloTarifaPrecioDTOCopyWith<_$_ArticuloTarifaPrecioDTO>
      get copyWith =>
          __$$_ArticuloTarifaPrecioDTOCopyWithImpl<_$_ArticuloTarifaPrecioDTO>(
              this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_ArticuloTarifaPrecioDTOToJson(
      this,
    );
  }
}

abstract class _ArticuloTarifaPrecioDTO extends ArticuloTarifaPrecioDTO {
  const factory _ArticuloTarifaPrecioDTO(
  ...
  const _ArticuloTarifaPrecioDTO._() : super._();

  factory _ArticuloTarifaPrecioDTO.fromJson(Map<String, dynamic> json) =
      _$_ArticuloTarifaPrecioDTO.fromJson;
