...
_ArticuloPedidoVentaLineaDTO _$ArticuloPedidoVentaLineaDTOFromJson(
...
Map<String, dynamic> _$ArticuloPedidoVentaLineaDTOToJson(
  _ArticuloPedidoVentaLineaDTO instance,
) => <String, dynamic>{
