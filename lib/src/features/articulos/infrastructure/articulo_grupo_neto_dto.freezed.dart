...
bool operator ==(Object other) {
  final _this = this as ArticuloGrupoNetoDTO;
...
int get hashCode {
  final _this = this as ArticuloGrupoNetoDTO;
  return Object.hash(runtimeType,_this.articuloId,_this.grupoNetoId,_this.grupoNetoDescripcion,_this.cantidadDesde,_this.precio,_this.divisaId,_this.tipoPrecio,_this.lastUpdated,_this.deleted);
}

@override
String toString() {
  final _this = this as ArticuloGrupoNetoDTO;
  return 'ArticuloGrupoNetoDTO(articuloId: ${_this.articuloId}, grupoNetoId: ${_this.grupoNetoId}, grupoNetoDescripcion: ${_this.grupoNetoDescripcion}, cantidadDesde: ${_this.cantidadDesde}, precio: ${_this.precio}, divisaId: ${_this.divisaId}, tipoPrecio: ${_this.tipoPrecio}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? articuloId = null,Object? grupoNetoId = null,Object? grupoNetoDescripcion = null,Object? cantidadDesde = null,Object? precio = null,Object? divisaId = null,Object? tipoPrecio = null,Object? lastUpdated = null,Object? deleted = null,}) {
  return _then(ArticuloGrupoNetoDTO(
...
@override
int get hashCode {
    return Object.hash(runtimeType,articuloId,grupoNetoId,grupoNetoDescripcion,cantidadDesde,precio,divisaId,tipoPrecio,lastUpdated,deleted);
}
