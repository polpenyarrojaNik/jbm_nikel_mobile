...
_ArticuloDTO _$ArticuloDTOFromJson(Map<String, dynamic> json) => _ArticuloDTO(
  ...
  comprasEntregaEstado3: json['COMPRAS_ENTREGA_ESTADO_3'] as String?,
...
Map<String, dynamic> _$ArticuloDTOToJson(
  _ArticuloDTO instance,
) => <String, dynamic>{
  ...
  'COMPRAS_ENTREGA_ESTADO_3': instance.comprasEntregaEstado3,
