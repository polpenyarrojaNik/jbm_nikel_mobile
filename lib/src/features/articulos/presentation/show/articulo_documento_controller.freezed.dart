...
part of 'articulo_documento_controller.dart';
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is ArticuloDocumentoState);
}
...
/// @nodoc
class $ArticuloDocumentoStateCopyWith<$Res>  {
$ArticuloDocumentoStateCopyWith(ArticuloDocumentoState _, $Res Function(ArticuloDocumentoState) __);
}


/// Adds pattern-matching-related methods to [ArticuloDocumentoState].
extension ArticuloDocumentoStatePatterns on ArticuloDocumentoState {
...
class _Initial extends ArticuloDocumentoState {
...
@override
String toString() {
  return 'ArticuloDocumentoState.initial()';
}
...
class _Loading extends ArticuloDocumentoState {
...
@override
String toString() {
  return 'ArticuloDocumentoState.loading()';
}
...
class _Data extends ArticuloDocumentoState {
...
@override
String toString() {
  return 'ArticuloDocumentoState.data(file: $file)';
}
...
/// @nodoc
abstract mixin class _$DataCopyWith<$Res> implements $ArticuloDocumentoStateCopyWith<$Res> {
...
class _Error extends ArticuloDocumentoState {
...
@override
String toString() {
  return 'ArticuloDocumentoState.error(failure: $failure)';
}
...
/// @nodoc
abstract mixin class _$ErrorCopyWith<$Res> implements $ArticuloDocumentoStateCopyWith<$Res> {
