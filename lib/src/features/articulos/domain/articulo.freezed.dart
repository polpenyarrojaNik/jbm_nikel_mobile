...
mixin _$Articulo {
 ...
 String get id; String get descripcionES; String? get descripcionEN; String? get descripcionFR; String? get descripcionDE; String? get descripcionCA; String? get descripcionGB; String? get descripcionHU; String? get descripcionIT; String? get descripcionNL; String? get descripcionPL; String? get descripcionPT; String? get descripcionRO; String? get descripcionRU; String? get descripcionCN; String? get descripcionEL; Familia? get familia; Subfamilia? get subfamilia; int get ventaMinimo; int get ventaMultiplo; int get unidadesSubcaja; int get unidadesCaja; int get unidadesPalet; bool get activoWeb; bool get activoApp; bool get enCatalogo; bool get descatalogado; String? get paginaEnCatalgo; String? get paginaEnCatalgo2; double get pesoKg; double get largoCm; double get anchoCm; double get altoCm; String? get resumenES; String? get resumenEN; String? get resumenFR; String? get resumenDE; String? get resumenCA; String? get resumenGB; String? get resumenHU; String? get resumenIT; String? get resumenNL; String? get resumenPL; String? get resumenPT; String? get resumenRO; String? get resumenRU; String? get resumenCN; String? get resumenEL; int get stockDisponible; Money get ventasActual; Money get ventasAnterior; int get comprasEntregaCantidad1; int get comprasEntregaCantidad2; int get comprasEntregaCantidad3; int get comprasEntregaCantidadMas3; DateTime? get comprasEntregaFecha1; DateTime? get comprasEntregaFecha2; DateTime? get comprasEntregaFecha3; String? get comprasEntregaEstado1; String? get comprasEntregaEstado2; String? get comprasEntregaEstado3; String? get imagenPrincipal; String? get gtin13Unidad; String? get gs1128Subcaja; String? get gs1128Caja; String? get gs1128Palet; int? get ventasOrden; Money? get costeUnitario; Money get ventasAnyoActual; Money get ventasAnyoAnterior; Money get ventasHaceDosAnyos; double get margenAnyoActual; double get margenAnyoAnterior; double get margenHaceDosAnyos; DateTime get lastUpdated; bool get deleted;
...
bool operator ==(Object other) {
  final _this = this as Articulo;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Articulo&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.descripcionES, _this.descripcionES) || other.descripcionES == _this.descripcionES)&&(identical(other.descripcionEN, _this.descripcionEN) || other.descripcionEN == _this.descripcionEN)&&(identical(other.descripcionFR, _this.descripcionFR) || other.descripcionFR == _this.descripcionFR)&&(identical(other.descripcionDE, _this.descripcionDE) || other.descripcionDE == _this.descripcionDE)&&(identical(other.descripcionCA, _this.descripcionCA) || other.descripcionCA == _this.descripcionCA)&&(identical(other.descripcionGB, _this.descripcionGB) || other.descripcionGB == _this.descripcionGB)&&(identical(other.descripcionHU, _this.descripcionHU) || other.descripcionHU == _this.descripcionHU)&&(identical(other.descripcionIT, _this.descripcionIT) || other.descripcionIT == _this.descripcionIT)&&(identical(other.descripcionNL, _this.descripcionNL) || other.descripcionNL == _this.descripcionNL)&&(identical(other.descripcionPL, _this.descripcionPL) || other.descripcionPL == _this.descripcionPL)&&(identical(other.descripcionPT, _this.descripcionPT) || other.descripcionPT == _this.descripcionPT)&&(identical(other.descripcionRO, _this.descripcionRO) || other.descripcionRO == _this.descripcionRO)&&(identical(other.descripcionRU, _this.descripcionRU) || other.descripcionRU == _this.descripcionRU)&&(identical(other.descripcionCN, _this.descripcionCN) || other.descripcionCN == _this.descripcionCN)&&(identical(other.descripcionEL, _this.descripcionEL) || other.descripcionEL == _this.descripcionEL)&&(identical(other.familia, _this.familia) || other.familia == _this.familia)&&(identical(other.subfamilia, _this.subfamilia) || other.subfamilia == _this.subfamilia)&&(identical(other.ventaMinimo, _this.ventaMinimo) || other.ventaMinimo == _this.ventaMinimo)&&(identical(other.ventaMultiplo, _this.ventaMultiplo) || other.ventaMultiplo == _this.ventaMultiplo)&&(identical(other.unidadesSubcaja, _this.unidadesSubcaja) || other.unidadesSubcaja == _this.unidadesSubcaja)&&(identical(other.unidadesCaja, _this.unidadesCaja) || other.unidadesCaja == _this.unidadesCaja)&&(identical(other.unidadesPalet, _this.unidadesPalet) || other.unidadesPalet == _this.unidadesPalet)&&(identical(other.activoWeb, _this.activoWeb) || other.activoWeb == _this.activoWeb)&&(identical(other.activoApp, _this.activoApp) || other.activoApp == _this.activoApp)&&(identical(other.enCatalogo, _this.enCatalogo) || other.enCatalogo == _this.enCatalogo)&&(identical(other.descatalogado, _this.descatalogado) || other.descatalogado == _this.descatalogado)&&(identical(other.paginaEnCatalgo, _this.paginaEnCatalgo) || other.paginaEnCatalgo == _this.paginaEnCatalgo)&&(identical(other.paginaEnCatalgo2, _this.paginaEnCatalgo2) || other.paginaEnCatalgo2 == _this.paginaEnCatalgo2)&&(identical(other.pesoKg, _this.pesoKg) || other.pesoKg == _this.pesoKg)&&(identical(other.largoCm, _this.largoCm) || other.largoCm == _this.largoCm)&&(identical(other.anchoCm, _this.anchoCm) || other.anchoCm == _this.anchoCm)&&(identical(other.altoCm, _this.altoCm) || other.altoCm == _this.altoCm)&&(identical(other.resumenES, _this.resumenES) || other.resumenES == _this.resumenES)&&(identical(other.resumenEN, _this.resumenEN) || other.resumenEN == _this.resumenEN)&&(identical(other.resumenFR, _this.resumenFR) || other.resumenFR == _this.resumenFR)&&(identical(other.resumenDE, _this.resumenDE) || other.resumenDE == _this.resumenDE)&&(identical(other.resumenCA, _this.resumenCA) || other.resumenCA == _this.resumenCA)&&(identical(other.resumenGB, _this.resumenGB) || other.resumenGB == _this.resumenGB)&&(identical(other.resumenHU, _this.resumenHU) || other.resumenHU == _this.resumenHU)&&(identical(other.resumenIT, _this.resumenIT) || other.resumenIT == _this.resumenIT)&&(identical(other.resumenNL, _this.resumenNL) || other.resumenNL == _this.resumenNL)&&(identical(other.resumenPL, _this.resumenPL) || other.resumenPL == _this.resumenPL)&&(identical(other.resumenPT, _this.resumenPT) || other.resumenPT == _this.resumenPT)&&(identical(other.resumenRO, _this.resumenRO) || other.resumenRO == _this.resumenRO)&&(identical(other.resumenRU, _this.resumenRU) || other.resumenRU == _this.resumenRU)&&(identical(other.resumenCN, _this.resumenCN) || other.resumenCN == _this.resumenCN)&&(identical(other.resumenEL, _this.resumenEL) || other.resumenEL == _this.resumenEL)&&(identical(other.stockDisponible, _this.stockDisponible) || other.stockDisponible == _this.stockDisponible)&&(identical(other.ventasActual, _this.ventasActual) || other.ventasActual == _this.ventasActual)&&(identical(other.ventasAnterior, _this.ventasAnterior) || other.ventasAnterior == _this.ventasAnterior)&&(identical(other.comprasEntregaCantidad1, _this.comprasEntregaCantidad1) || other.comprasEntregaCantidad1 == _this.comprasEntregaCantidad1)&&(identical(other.comprasEntregaCantidad2, _this.comprasEntregaCantidad2) || other.comprasEntregaCantidad2 == _this.comprasEntregaCantidad2)&&(identical(other.comprasEntregaCantidad3, _this.comprasEntregaCantidad3) || other.comprasEntregaCantidad3 == _this.comprasEntregaCantidad3)&&(identical(other.comprasEntregaCantidadMas3, _this.comprasEntregaCantidadMas3) || other.comprasEntregaCantidadMas3 == _this.comprasEntregaCantidadMas3)&&(identical(other.comprasEntregaFecha1, _this.comprasEntregaFecha1) || other.comprasEntregaFecha1 == _this.comprasEntregaFecha1)&&(identical(other.comprasEntregaFecha2, _this.comprasEntregaFecha2) || other.comprasEntregaFecha2 == _this.comprasEntregaFecha2)&&(identical(other.comprasEntregaFecha3, _this.comprasEntregaFecha3) || other.comprasEntregaFecha3 == _this.comprasEntregaFecha3)&&(identical(other.comprasEntregaEstado1, _this.comprasEntregaEstado1) || other.comprasEntregaEstado1 == _this.comprasEntregaEstado1)&&(identical(other.comprasEntregaEstado2, _this.comprasEntregaEstado2) || other.comprasEntregaEstado2 == _this.comprasEntregaEstado2)&&(identical(other.comprasEntregaEstado3, _this.comprasEntregaEstado3) || other.comprasEntregaEstado3 == _this.comprasEntregaEstado3)&&(identical(other.imagenPrincipal, _this.imagenPrincipal) || other.imagenPrincipal == _this.imagenPrincipal)&&(identical(other.gtin13Unidad, _this.gtin13Unidad) || other.gtin13Unidad == _this.gtin13Unidad)&&(identical(other.gs1128Subcaja, _this.gs1128Subcaja) || other.gs1128Subcaja == _this.gs1128Subcaja)&&(identical(other.gs1128Caja, _this.gs1128Caja) || other.gs1128Caja == _this.gs1128Caja)&&(identical(other.gs1128Palet, _this.gs1128Palet) || other.gs1128Palet == _this.gs1128Palet)&&(identical(other.ventasOrden, _this.ventasOrden) || other.ventasOrden == _this.ventasOrden)&&(identical(other.costeUnitario, _this.costeUnitario) || other.costeUnitario == _this.costeUnitario)&&(identical(other.ventasAnyoActual, _this.ventasAnyoActual) || other.ventasAnyoActual == _this.ventasAnyoActual)&&(identical(other.ventasAnyoAnterior, _this.ventasAnyoAnterior) || other.ventasAnyoAnterior == _this.ventasAnyoAnterior)&&(identical(other.ventasHaceDosAnyos, _this.ventasHaceDosAnyos) || other.ventasHaceDosAnyos == _this.ventasHaceDosAnyos)&&(identical(other.margenAnyoActual, _this.margenAnyoActual) || other.margenAnyoActual == _this.margenAnyoActual)&&(identical(other.margenAnyoAnterior, _this.margenAnyoAnterior) || other.margenAnyoAnterior == _this.margenAnyoAnterior)&&(identical(other.margenHaceDosAnyos, _this.margenHaceDosAnyos) || other.margenHaceDosAnyos == _this.margenHaceDosAnyos)&&(identical(other.lastUpdated, _this.lastUpdated) || other.lastUpdated == _this.lastUpdated)&&(identical(other.deleted, _this.deleted) || other.deleted == _this.deleted));
}
...
int get hashCode {
  final _this = this as Articulo;
  return Object.hashAll([runtimeType,_this.id,_this.descripcionES,_this.descripcionEN,_this.descripcionFR,_this.descripcionDE,_this.descripcionCA,_this.descripcionGB,_this.descripcionHU,_this.descripcionIT,_this.descripcionNL,_this.descripcionPL,_this.descripcionPT,_this.descripcionRO,_this.descripcionRU,_this.descripcionCN,_this.descripcionEL,_this.familia,_this.subfamilia,_this.ventaMinimo,_this.ventaMultiplo,_this.unidadesSubcaja,_this.unidadesCaja,_this.unidadesPalet,_this.activoWeb,_this.activoApp,_this.enCatalogo,_this.descatalogado,_this.paginaEnCatalgo,_this.paginaEnCatalgo2,_this.pesoKg,_this.largoCm,_this.anchoCm,_this.altoCm,_this.resumenES,_this.resumenEN,_this.resumenFR,_this.resumenDE,_this.resumenCA,_this.resumenGB,_this.resumenHU,_this.resumenIT,_this.resumenNL,_this.resumenPL,_this.resumenPT,_this.resumenRO,_this.resumenRU,_this.resumenCN,_this.resumenEL,_this.stockDisponible,_this.ventasActual,_this.ventasAnterior,_this.comprasEntregaCantidad1,_this.comprasEntregaCantidad2,_this.comprasEntregaCantidad3,_this.comprasEntregaCantidadMas3,_this.comprasEntregaFecha1,_this.comprasEntregaFecha2,_this.comprasEntregaFecha3,_this.comprasEntregaEstado1,_this.comprasEntregaEstado2,_this.comprasEntregaEstado3,_this.imagenPrincipal,_this.gtin13Unidad,_this.gs1128Subcaja,_this.gs1128Caja,_this.gs1128Palet,_this.ventasOrden,_this.costeUnitario,_this.ventasAnyoActual,_this.ventasAnyoAnterior,_this.ventasHaceDosAnyos,_this.margenAnyoActual,_this.margenAnyoAnterior,_this.margenHaceDosAnyos,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as Articulo;
  return 'Articulo(id: ${_this.id}, descripcionES: ${_this.descripcionES}, descripcionEN: ${_this.descripcionEN}, descripcionFR: ${_this.descripcionFR}, descripcionDE: ${_this.descripcionDE}, descripcionCA: ${_this.descripcionCA}, descripcionGB: ${_this.descripcionGB}, descripcionHU: ${_this.descripcionHU}, descripcionIT: ${_this.descripcionIT}, descripcionNL: ${_this.descripcionNL}, descripcionPL: ${_this.descripcionPL}, descripcionPT: ${_this.descripcionPT}, descripcionRO: ${_this.descripcionRO}, descripcionRU: ${_this.descripcionRU}, descripcionCN: ${_this.descripcionCN}, descripcionEL: ${_this.descripcionEL}, familia: ${_this.familia}, subfamilia: ${_this.subfamilia}, ventaMinimo: ${_this.ventaMinimo}, ventaMultiplo: ${_this.ventaMultiplo}, unidadesSubcaja: ${_this.unidadesSubcaja}, unidadesCaja: ${_this.unidadesCaja}, unidadesPalet: ${_this.unidadesPalet}, activoWeb: ${_this.activoWeb}, activoApp: ${_this.activoApp}, enCatalogo: ${_this.enCatalogo}, descatalogado: ${_this.descatalogado}, paginaEnCatalgo: ${_this.paginaEnCatalgo}, paginaEnCatalgo2: ${_this.paginaEnCatalgo2}, pesoKg: ${_this.pesoKg}, largoCm: ${_this.largoCm}, anchoCm: ${_this.anchoCm}, altoCm: ${_this.altoCm}, resumenES: ${_this.resumenES}, resumenEN: ${_this.resumenEN}, resumenFR: ${_this.resumenFR}, resumenDE: ${_this.resumenDE}, resumenCA: ${_this.resumenCA}, resumenGB: ${_this.resumenGB}, resumenHU: ${_this.resumenHU}, resumenIT: ${_this.resumenIT}, resumenNL: ${_this.resumenNL}, resumenPL: ${_this.resumenPL}, resumenPT: ${_this.resumenPT}, resumenRO: ${_this.resumenRO}, resumenRU: ${_this.resumenRU}, resumenCN: ${_this.resumenCN}, resumenEL: ${_this.resumenEL}, stockDisponible: ${_this.stockDisponible}, ventasActual: ${_this.ventasActual}, ventasAnterior: ${_this.ventasAnterior}, comprasEntregaCantidad1: ${_this.comprasEntregaCantidad1}, comprasEntregaCantidad2: ${_this.comprasEntregaCantidad2}, comprasEntregaCantidad3: ${_this.comprasEntregaCantidad3}, comprasEntregaCantidadMas3: ${_this.comprasEntregaCantidadMas3}, comprasEntregaFecha1: ${_this.comprasEntregaFecha1}, comprasEntregaFecha2: ${_this.comprasEntregaFecha2}, comprasEntregaFecha3: ${_this.comprasEntregaFecha3}, comprasEntregaEstado1: ${_this.comprasEntregaEstado1}, comprasEntregaEstado2: ${_this.comprasEntregaEstado2}, comprasEntregaEstado3: ${_this.comprasEntregaEstado3}, imagenPrincipal: ${_this.imagenPrincipal}, gtin13Unidad: ${_this.gtin13Unidad}, gs1128Subcaja: ${_this.gs1128Subcaja}, gs1128Caja: ${_this.gs1128Caja}, gs1128Palet: ${_this.gs1128Palet}, ventasOrden: ${_this.ventasOrden}, costeUnitario: ${_this.costeUnitario}, ventasAnyoActual: ${_this.ventasAnyoActual}, ventasAnyoAnterior: ${_this.ventasAnyoAnterior}, ventasHaceDosAnyos: ${_this.ventasHaceDosAnyos}, margenAnyoActual: ${_this.margenAnyoActual}, margenAnyoAnterior: ${_this.margenAnyoAnterior}, margenHaceDosAnyos: ${_this.margenHaceDosAnyos}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@useResult
$Res call({
 String id, String descripcionES, String? descripcionEN, String? descripcionFR, String? descripcionDE, String? descripcionCA, String? descripcionGB, String? descripcionHU, String? descripcionIT, String? descripcionNL, String? descripcionPL, String? descripcionPT, String? descripcionRO, String? descripcionRU, String? descripcionCN, String? descripcionEL, Familia? familia, Subfamilia? subfamilia, int ventaMinimo, int ventaMultiplo, int unidadesSubcaja, int unidadesCaja, int unidadesPalet, bool activoWeb, bool activoApp, bool enCatalogo, bool descatalogado, String? paginaEnCatalgo, String? paginaEnCatalgo2, double pesoKg, double largoCm, double anchoCm, double altoCm, String? resumenES, String? resumenEN, String? resumenFR, String? resumenDE, String? resumenCA, String? resumenGB, String? resumenHU, String? resumenIT, String? resumenNL, String? resumenPL, String? resumenPT, String? resumenRO, String? resumenRU, String? resumenCN, String? resumenEL, int stockDisponible, Money ventasActual, Money ventasAnterior, int comprasEntregaCantidad1, int comprasEntregaCantidad2, int comprasEntregaCantidad3, int comprasEntregaCantidadMas3, DateTime? comprasEntregaFecha1, DateTime? comprasEntregaFecha2, DateTime? comprasEntregaFecha3, String? comprasEntregaEstado1, String? comprasEntregaEstado2, String? comprasEntregaEstado3, String? imagenPrincipal, String? gtin13Unidad, String? gs1128Subcaja, String? gs1128Caja, String? gs1128Palet, int? ventasOrden, Money? costeUnitario, Money ventasAnyoActual, Money ventasAnyoAnterior, Money ventasHaceDosAnyos, double margenAnyoActual, double margenAnyoAnterior, double margenHaceDosAnyos, DateTime lastUpdated, bool deleted
});
...
as String?,familia: freezed == familia ? _self.familia : familia // ignore: cast_nullable_to_non_nullable
as Familia?,subfamilia: freezed == subfamilia ? _self.subfamilia : subfamilia // ignore: cast_nullable_to_non_nullable
as Subfamilia?,ventaMinimo: null == ventaMinimo ? _self.ventaMinimo : ventaMinimo // ignore: cast_nullable_to_non_nullable
...
as bool,activoApp: null == activoApp ? _self.activoApp : activoApp // ignore: cast_nullable_to_non_nullable
as bool,enCatalogo: null == enCatalogo ? _self.enCatalogo : enCatalogo // ignore: cast_nullable_to_non_nullable
as bool,descatalogado: null == descatalogado ? _self.descatalogado : descatalogado // ignore: cast_nullable_to_non_nullable
as bool,paginaEnCatalgo: freezed == paginaEnCatalgo ? _self.paginaEnCatalgo : paginaEnCatalgo // ignore: cast_nullable_to_non_nullable
...
as Money,comprasEntregaCantidad1: null == comprasEntregaCantidad1 ? _self.comprasEntregaCantidad1 : comprasEntregaCantidad1 // ignore: cast_nullable_to_non_nullable
...
as Money?,ventasAnyoActual: null == ventasAnyoActual ? _self.ventasAnyoActual : ventasAnyoActual // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String descripcionES,  String? descripcionEN,  String? descripcionFR,  String? descripcionDE,  String? descripcionCA,  String? descripcionGB,  String? descripcionHU,  String? descripcionIT,  String? descripcionNL,  String? descripcionPL,  String? descripcionPT,  String? descripcionRO,  String? descripcionRU,  String? descripcionCN,  String? descripcionEL,  Familia? familia,  Subfamilia? subfamilia,  int ventaMinimo,  int ventaMultiplo,  int unidadesSubcaja,  int unidadesCaja,  int unidadesPalet,  bool activoWeb,  bool activoApp,  bool enCatalogo,  bool descatalogado,  String? paginaEnCatalgo,  String? paginaEnCatalgo2,  double pesoKg,  double largoCm,  double anchoCm,  double altoCm,  String? resumenES,  String? resumenEN,  String? resumenFR,  String? resumenDE,  String? resumenCA,  String? resumenGB,  String? resumenHU,  String? resumenIT,  String? resumenNL,  String? resumenPL,  String? resumenPT,  String? resumenRO,  String? resumenRU,  String? resumenCN,  String? resumenEL,  int stockDisponible,  Money ventasActual,  Money ventasAnterior,  int comprasEntregaCantidad1,  int comprasEntregaCantidad2,  int comprasEntregaCantidad3,  int comprasEntregaCantidadMas3,  DateTime? comprasEntregaFecha1,  DateTime? comprasEntregaFecha2,  DateTime? comprasEntregaFecha3,  String? comprasEntregaEstado1,  String? comprasEntregaEstado2,  String? comprasEntregaEstado3,  String? imagenPrincipal,  String? gtin13Unidad,  String? gs1128Subcaja,  String? gs1128Caja,  String? gs1128Palet,  int? ventasOrden,  Money? costeUnitario,  Money ventasAnyoActual,  Money ventasAnyoAnterior,  Money ventasHaceDosAnyos,  double margenAnyoActual,  double margenAnyoAnterior,  double margenHaceDosAnyos,  DateTime lastUpdated,  bool deleted)  $default,) {final _that = this;
switch (_that) {
case _Articulo():
return $default(_that.id,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL,_that.descripcionPT,_that.descripcionRO,_that.descripcionRU,_that.descripcionCN,_that.descripcionEL,_that.familia,_that.subfamilia,_that.ventaMinimo,_that.ventaMultiplo,_that.unidadesSubcaja,_that.unidadesCaja,_that.unidadesPalet,_that.activoWeb,_that.activoApp,_that.enCatalogo,_that.descatalogado,_that.paginaEnCatalgo,_that.paginaEnCatalgo2,_that.pesoKg,_that.largoCm,_that.anchoCm,_that.altoCm,_that.resumenES,_that.resumenEN,_that.resumenFR,_that.resumenDE,_that.resumenCA,_that.resumenGB,_that.resumenHU,_that.resumenIT,_that.resumenNL,_that.resumenPL,_that.resumenPT,_that.resumenRO,_that.resumenRU,_that.resumenCN,_that.resumenEL,_that.stockDisponible,_that.ventasActual,_that.ventasAnterior,_that.comprasEntregaCantidad1,_that.comprasEntregaCantidad2,_that.comprasEntregaCantidad3,_that.comprasEntregaCantidadMas3,_that.comprasEntregaFecha1,_that.comprasEntregaFecha2,_that.comprasEntregaFecha3,_that.comprasEntregaEstado1,_that.comprasEntregaEstado2,_that.comprasEntregaEstado3,_that.imagenPrincipal,_that.gtin13Unidad,_that.gs1128Subcaja,_that.gs1128Caja,_that.gs1128Palet,_that.ventasOrden,_that.costeUnitario,_that.ventasAnyoActual,_that.ventasAnyoAnterior,_that.ventasHaceDosAnyos,_that.margenAnyoActual,_that.margenAnyoAnterior,_that.margenHaceDosAnyos,_that.lastUpdated,_that.deleted);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String descripcionES,  String? descripcionEN,  String? descripcionFR,  String? descripcionDE,  String? descripcionCA,  String? descripcionGB,  String? descripcionHU,  String? descripcionIT,  String? descripcionNL,  String? descripcionPL,  String? descripcionPT,  String? descripcionRO,  String? descripcionRU,  String? descripcionCN,  String? descripcionEL,  Familia? familia,  Subfamilia? subfamilia,  int ventaMinimo,  int ventaMultiplo,  int unidadesSubcaja,  int unidadesCaja,  int unidadesPalet,  bool activoWeb,  bool activoApp,  bool enCatalogo,  bool descatalogado,  String? paginaEnCatalgo,  String? paginaEnCatalgo2,  double pesoKg,  double largoCm,  double anchoCm,  double altoCm,  String? resumenES,  String? resumenEN,  String? resumenFR,  String? resumenDE,  String? resumenCA,  String? resumenGB,  String? resumenHU,  String? resumenIT,  String? resumenNL,  String? resumenPL,  String? resumenPT,  String? resumenRO,  String? resumenRU,  String? resumenCN,  String? resumenEL,  int stockDisponible,  Money ventasActual,  Money ventasAnterior,  int comprasEntregaCantidad1,  int comprasEntregaCantidad2,  int comprasEntregaCantidad3,  int comprasEntregaCantidadMas3,  DateTime? comprasEntregaFecha1,  DateTime? comprasEntregaFecha2,  DateTime? comprasEntregaFecha3,  String? comprasEntregaEstado1,  String? comprasEntregaEstado2,  String? comprasEntregaEstado3,  String? imagenPrincipal,  String? gtin13Unidad,  String? gs1128Subcaja,  String? gs1128Caja,  String? gs1128Palet,  int? ventasOrden,  Money? costeUnitario,  Money ventasAnyoActual,  Money ventasAnyoAnterior,  Money ventasHaceDosAnyos,  double margenAnyoActual,  double margenAnyoAnterior,  double margenHaceDosAnyos,  DateTime lastUpdated,  bool deleted)?  $default,) {final _that = this;
switch (_that) {
case _Articulo() when $default != null:
return $default(_that.id,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL,_that.descripcionPT,_that.descripcionRO,_that.descripcionRU,_that.descripcionCN,_that.descripcionEL,_that.familia,_that.subfamilia,_that.ventaMinimo,_that.ventaMultiplo,_that.unidadesSubcaja,_that.unidadesCaja,_that.unidadesPalet,_that.activoWeb,_that.activoApp,_that.enCatalogo,_that.descatalogado,_that.paginaEnCatalgo,_that.paginaEnCatalgo2,_that.pesoKg,_that.largoCm,_that.anchoCm,_that.altoCm,_that.resumenES,_that.resumenEN,_that.resumenFR,_that.resumenDE,_that.resumenCA,_that.resumenGB,_that.resumenHU,_that.resumenIT,_that.resumenNL,_that.resumenPL,_that.resumenPT,_that.resumenRO,_that.resumenRU,_that.resumenCN,_that.resumenEL,_that.stockDisponible,_that.ventasActual,_that.ventasAnterior,_that.comprasEntregaCantidad1,_that.comprasEntregaCantidad2,_that.comprasEntregaCantidad3,_that.comprasEntregaCantidadMas3,_that.comprasEntregaFecha1,_that.comprasEntregaFecha2,_that.comprasEntregaFecha3,_that.comprasEntregaEstado1,_that.comprasEntregaEstado2,_that.comprasEntregaEstado3,_that.imagenPrincipal,_that.gtin13Unidad,_that.gs1128Subcaja,_that.gs1128Caja,_that.gs1128Palet,_that.ventasOrden,_that.costeUnitario,_that.ventasAnyoActual,_that.ventasAnyoAnterior,_that.ventasHaceDosAnyos,_that.margenAnyoActual,_that.margenAnyoAnterior,_that.margenHaceDosAnyos,_that.lastUpdated,_that.deleted);case _:
  return null;
...
class _Articulo extends Articulo {
  const _Articulo({required this.id, required this.descripcionES, this.descripcionEN, this.descripcionFR, this.descripcionDE, this.descripcionCA, this.descripcionGB, this.descripcionHU, this.descripcionIT, this.descripcionNL, this.descripcionPL, this.descripcionPT, this.descripcionRO, this.descripcionRU, this.descripcionCN, this.descripcionEL, this.familia, this.subfamilia, required this.ventaMinimo, required this.ventaMultiplo, required this.unidadesSubcaja, required this.unidadesCaja, required this.unidadesPalet, required this.activoWeb, required this.activoApp, required this.enCatalogo, required this.descatalogado, this.paginaEnCatalgo, this.paginaEnCatalgo2, required this.pesoKg, required this.largoCm, required this.anchoCm, required this.altoCm, this.resumenES, this.resumenEN, this.resumenFR, this.resumenDE, this.resumenCA, this.resumenGB, this.resumenHU, this.resumenIT, this.resumenNL, this.resumenPL, this.resumenPT, this.resumenRO, this.resumenRU, this.resumenCN, this.resumenEL, required this.stockDisponible, required this.ventasActual, required this.ventasAnterior, required this.comprasEntregaCantidad1, required this.comprasEntregaCantidad2, required this.comprasEntregaCantidad3, required this.comprasEntregaCantidadMas3, this.comprasEntregaFecha1, this.comprasEntregaFecha2, this.comprasEntregaFecha3, this.comprasEntregaEstado1, this.comprasEntregaEstado2, this.comprasEntregaEstado3, this.imagenPrincipal, this.gtin13Unidad, this.gs1128Subcaja, this.gs1128Caja, this.gs1128Palet, this.ventasOrden, this.costeUnitario, required this.ventasAnyoActual, required this.ventasAnyoAnterior, required this.ventasHaceDosAnyos, required this.margenAnyoActual, required this.margenAnyoAnterior, required this.margenHaceDosAnyos, required this.lastUpdated, required this.deleted}): super._();
...
@override final  int ventaMinimo;
@override final  int ventaMultiplo;
@override final  int unidadesSubcaja;
@override final  int unidadesCaja;
@override final  int unidadesPalet;
@override final  bool activoWeb;
@override final  bool activoApp;
@override final  bool enCatalogo;
@override final  bool descatalogado;
@override final  String? paginaEnCatalgo;
@override final  String? paginaEnCatalgo2;
@override final  double pesoKg;
@override final  double largoCm;
@override final  double anchoCm;
@override final  double altoCm;
@override final  String? resumenES;
@override final  String? resumenEN;
@override final  String? resumenFR;
@override final  String? resumenDE;
@override final  String? resumenCA;
@override final  String? resumenGB;
@override final  String? resumenHU;
@override final  String? resumenIT;
@override final  String? resumenNL;
@override final  String? resumenPL;
@override final  String? resumenPT;
@override final  String? resumenRO;
@override final  String? resumenRU;
@override final  String? resumenCN;
@override final  String? resumenEL;
@override final  int stockDisponible;
@override final  Money ventasActual;
@override final  Money ventasAnterior;
@override final  int comprasEntregaCantidad1;
@override final  int comprasEntregaCantidad2;
@override final  int comprasEntregaCantidad3;
@override final  int comprasEntregaCantidadMas3;
@override final  DateTime? comprasEntregaFecha1;
@override final  DateTime? comprasEntregaFecha2;
@override final  DateTime? comprasEntregaFecha3;
@override final  String? comprasEntregaEstado1;
@override final  String? comprasEntregaEstado2;
@override final  String? comprasEntregaEstado3;
@override final  String? imagenPrincipal;
@override final  String? gtin13Unidad;
@override final  String? gs1128Subcaja;
@override final  String? gs1128Caja;
@override final  String? gs1128Palet;
@override final  int? ventasOrden;
@override final  Money? costeUnitario;
