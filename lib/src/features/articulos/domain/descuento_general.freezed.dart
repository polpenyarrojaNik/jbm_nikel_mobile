...
bool operator ==(Object other) {
  final _this = this as DescuentoGeneral;
...
String toString() {
  final _this = this as DescuentoGeneral;
  return 'DescuentoGeneral(descuentoGeneralId: ${_this.descuentoGeneralId}, articuloId: ${_this.articuloId}, familiaId: ${_this.familiaId}, subfamiliaId: ${_this.subfamiliaId}, cantidadDesde: ${_this.cantidadDesde}, descuento: ${_this.descuento}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
