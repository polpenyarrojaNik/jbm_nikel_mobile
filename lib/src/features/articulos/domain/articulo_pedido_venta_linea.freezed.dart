...
/// @nodoc
abstract class $ArticuloPedidoVentaLineaCopyWith<$Res> {
  factory $ArticuloPedidoVentaLineaCopyWith(ArticuloPedidoVentaLinea value,
          $Res Function(ArticuloPedidoVentaLinea) then) =
      _$ArticuloPedidoVentaLineaCopyWithImpl<$Res>;
  $Res call(
      {String empresaId,
...
class _$ArticuloPedidoVentaLineaCopyWithImpl<$Res>
  ...
  _$ArticuloPedidoVentaLineaCopyWithImpl(this._value, this._then);

  final ArticuloPedidoVentaLinea _value;
  // ignore: unused_field
...
class __$$_ArticuloPedidoVentaLineaCopyWithImpl<$Res>
  ...
  __$$_ArticuloPedidoVentaLineaCopyWithImpl(_$_ArticuloPedidoVentaLinea _value,
      ...
      : super(_value, (v) => _then(v as _$_ArticuloPedidoVentaLinea));

  @override
  _$_ArticuloPedidoVentaLinea get _value =>
      super._value as _$_ArticuloPedidoVentaLinea;
...
class _$_ArticuloPedidoVentaLinea extends _ArticuloPedidoVentaLinea {
  ...
  @override
  String toString() {
    return 'ArticuloPedidoVentaLinea(empresaId: $empresaId, pedidoVentaId: $pedidoVentaId, id: $id, articuloId: $articuloId, articuloDescription: $articuloDescription, clienteId: $clienteId, nombreCliente: $nombreCliente, cantidad: $cantidad, precioDivisa: $precioDivisa, tipoPrecio: $tipoPrecio, descuento1: $descuento1, descuento2: $descuento2, descuento3: $descuento3, lastUpdated: $lastUpdated, deleted: $deleted)';
  }
...
abstract class _ArticuloPedidoVentaLinea extends ArticuloPedidoVentaLinea {
  const factory _ArticuloPedidoVentaLinea(
