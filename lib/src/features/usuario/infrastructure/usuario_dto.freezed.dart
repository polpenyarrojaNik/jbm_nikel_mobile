...
bool operator ==(Object other) {
  final _this = this as UsuarioDTO;
...
int get hashCode {
  final _this = this as UsuarioDTO;
  return Object.hash(runtimeType,_this.id,_this.usuario,_this.contrasenya,_this.nombreUsuario,_this.provisionalToken,_this.refreshToken,_this.test,_this.idiomaId,_this.modificarPedido,_this.verTotalVentas,_this.packageName,_this.version,_this.buildNumber,_this.deviceInfo,_this.margenComercial,_this.costeSn,_this.filtroRepresentante,_this.aiSN);
}

@override
String toString() {
  final _this = this as UsuarioDTO;
  return 'UsuarioDTO(id: ${_this.id}, usuario: ${_this.usuario}, contrasenya: ${_this.contrasenya}, nombreUsuario: ${_this.nombreUsuario}, provisionalToken: ${_this.provisionalToken}, refreshToken: ${_this.refreshToken}, test: ${_this.test}, idiomaId: ${_this.idiomaId}, modificarPedido: ${_this.modificarPedido}, verTotalVentas: ${_this.verTotalVentas}, packageName: ${_this.packageName}, version: ${_this.version}, buildNumber: ${_this.buildNumber}, deviceInfo: ${_this.deviceInfo}, margenComercial: ${_this.margenComercial}, costeSn: ${_this.costeSn}, filtroRepresentante: ${_this.filtroRepresentante}, aiSN: ${_this.aiSN})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,usuario,contrasenya,nombreUsuario,provisionalToken,refreshToken,test,idiomaId,modificarPedido,verTotalVentas,packageName,version,buildNumber,deviceInfo,margenComercial,costeSn,filtroRepresentante,aiSN);
}

@override
String toString() {
    return 'UsuarioDTO(id: $id, usuario: $usuario, contrasenya: $contrasenya, nombreUsuario: $nombreUsuario, provisionalToken: $provisionalToken, refreshToken: $refreshToken, test: $test, idiomaId: $idiomaId, modificarPedido: $modificarPedido, verTotalVentas: $verTotalVentas, packageName: $packageName, version: $version, buildNumber: $buildNumber, deviceInfo: $deviceInfo, margenComercial: $margenComercial, costeSn: $costeSn, filtroRepresentante: $filtroRepresentante, aiSN: $aiSN)';
}
