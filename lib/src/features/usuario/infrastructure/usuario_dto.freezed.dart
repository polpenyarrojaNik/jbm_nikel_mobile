...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,usuario,contrasenya,nombreUsuario,provisionalToken,refreshToken,test,idiomaId,modificarPedido,verTotalVentas,packageName,version,buildNumber,deviceInfo,margenComercial,costeSn,filtroRepresentante,aiSN);
