...
int get hashCode {
  final _this = this as Usuario;
  return Object.hash(runtimeType,_this.id,_this.usuario,_this.contrasenya,_this.nombreUsuario,_this.refreshToken,_this.provisionalToken,_this.test,_this.idiomaId,_this.modificarPedido,_this.verTotalVentas,_this.margenComercial,_this.packageName,_this.version,_this.buildNumber,_this.deviceInfo,_this.costeSn,_this.filtroRepresentante,_this.aiSN);
}

@override
String toString() {
  final _this = this as Usuario;
  return 'Usuario(id: ${_this.id}, usuario: ${_this.usuario}, contrasenya: ${_this.contrasenya}, nombreUsuario: ${_this.nombreUsuario}, refreshToken: ${_this.refreshToken}, provisionalToken: ${_this.provisionalToken}, test: ${_this.test}, idiomaId: ${_this.idiomaId}, modificarPedido: ${_this.modificarPedido}, verTotalVentas: ${_this.verTotalVentas}, margenComercial: ${_this.margenComercial}, packageName: ${_this.packageName}, version: ${_this.version}, buildNumber: ${_this.buildNumber}, deviceInfo: ${_this.deviceInfo}, costeSn: ${_this.costeSn}, filtroRepresentante: ${_this.filtroRepresentante}, aiSN: ${_this.aiSN})';
}
...
@useResult
$Res call({
 String id, String usuario, String contrasenya, String? nombreUsuario, String? refreshToken, String provisionalToken, bool test, String idiomaId, bool modificarPedido, bool verTotalVentas, double margenComercial, String packageName, String version, String buildNumber, String deviceInfo, bool costeSn, bool filtroRepresentante, bool aiSN
});
...
as bool,aiSN: null == aiSN ? _self.aiSN : aiSN // ignore: cast_nullable_to_non_nullable
as bool,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String usuario,  String contrasenya,  String? nombreUsuario,  String? refreshToken,  String provisionalToken,  bool test,  String idiomaId,  bool modificarPedido,  bool verTotalVentas,  double margenComercial,  String packageName,  String version,  String buildNumber,  String deviceInfo,  bool costeSn,  bool filtroRepresentante,  bool aiSN)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Usuario() when $default != null:
return $default(_that.id,_that.usuario,_that.contrasenya,_that.nombreUsuario,_that.refreshToken,_that.provisionalToken,_that.test,_that.idiomaId,_that.modificarPedido,_that.verTotalVentas,_that.margenComercial,_that.packageName,_that.version,_that.buildNumber,_that.deviceInfo,_that.costeSn,_that.filtroRepresentante,_that.aiSN);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String usuario,  String contrasenya,  String? nombreUsuario,  String? refreshToken,  String provisionalToken,  bool test,  String idiomaId,  bool modificarPedido,  bool verTotalVentas,  double margenComercial,  String packageName,  String version,  String buildNumber,  String deviceInfo,  bool costeSn,  bool filtroRepresentante,  bool aiSN)  $default,) {final _that = this;
switch (_that) {
case _Usuario():
return $default(_that.id,_that.usuario,_that.contrasenya,_that.nombreUsuario,_that.refreshToken,_that.provisionalToken,_that.test,_that.idiomaId,_that.modificarPedido,_that.verTotalVentas,_that.margenComercial,_that.packageName,_that.version,_that.buildNumber,_that.deviceInfo,_that.costeSn,_that.filtroRepresentante,_that.aiSN);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String usuario,  String contrasenya,  String? nombreUsuario,  String? refreshToken,  String provisionalToken,  bool test,  String idiomaId,  bool modificarPedido,  bool verTotalVentas,  double margenComercial,  String packageName,  String version,  String buildNumber,  String deviceInfo,  bool costeSn,  bool filtroRepresentante,  bool aiSN)?  $default,) {final _that = this;
switch (_that) {
case _Usuario() when $default != null:
return $default(_that.id,_that.usuario,_that.contrasenya,_that.nombreUsuario,_that.refreshToken,_that.provisionalToken,_that.test,_that.idiomaId,_that.modificarPedido,_that.verTotalVentas,_that.margenComercial,_that.packageName,_that.version,_that.buildNumber,_that.deviceInfo,_that.costeSn,_that.filtroRepresentante,_that.aiSN);case _:
  return null;
...
@override
int get hashCode {
    return Object.hash(runtimeType,id,usuario,contrasenya,nombreUsuario,refreshToken,provisionalToken,test,idiomaId,modificarPedido,verTotalVentas,margenComercial,packageName,version,buildNumber,deviceInfo,costeSn,filtroRepresentante,aiSN);
}

@override
String toString() {
    return 'Usuario(id: $id, usuario: $usuario, contrasenya: $contrasenya, nombreUsuario: $nombreUsuario, refreshToken: $refreshToken, provisionalToken: $provisionalToken, test: $test, idiomaId: $idiomaId, modificarPedido: $modificarPedido, verTotalVentas: $verTotalVentas, margenComercial: $margenComercial, packageName: $packageName, version: $version, buildNumber: $buildNumber, deviceInfo: $deviceInfo, costeSn: $costeSn, filtroRepresentante: $filtroRepresentante, aiSN: $aiSN)';
}
