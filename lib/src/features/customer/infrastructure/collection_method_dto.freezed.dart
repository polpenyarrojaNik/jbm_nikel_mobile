...
part of 'collection_method_dto.dart';
...
CollectionMethodDTO _$CollectionMethodDTOFromJson(Map<String, dynamic> json) {
  return _CollectionMethodDTO.fromJson(json);
}

/// @nodoc
mixin _$CollectionMethodDTO {
  ...
  @JsonKey(ignore: true)
  $CollectionMethodDTOCopyWith<CollectionMethodDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CollectionMethodDTOCopyWith<$Res> {
  factory $CollectionMethodDTOCopyWith(
          CollectionMethodDTO value, $Res Function(CollectionMethodDTO) then) =
      _$CollectionMethodDTOCopyWithImpl<$Res>;
  $Res call(
...
/// @nodoc
class _$CollectionMethodDTOCopyWithImpl<$Res>
    implements $CollectionMethodDTOCopyWith<$Res> {
  _$CollectionMethodDTOCopyWithImpl(this._value, this._then);

  final CollectionMethodDTO _value;
  // ignore: unused_field
  final $Res Function(CollectionMethodDTO) _then;
...
/// @nodoc
abstract class _$$_CollectionMethodDTOCopyWith<$Res>
    implements $CollectionMethodDTOCopyWith<$Res> {
  factory _$$_CollectionMethodDTOCopyWith(_$_CollectionMethodDTO value,
          $Res Function(_$_CollectionMethodDTO) then) =
      __$$_CollectionMethodDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'METODO_COBRO_ID') String id,
      @JsonKey(name: 'DESCRIPCION_ES') String descriptionES,
...
/// @nodoc
class __$$_CollectionMethodDTOCopyWithImpl<$Res>
    extends _$CollectionMethodDTOCopyWithImpl<$Res>
    implements _$$_CollectionMethodDTOCopyWith<$Res> {
  __$$_CollectionMethodDTOCopyWithImpl(_$_CollectionMethodDTO _value,
      $Res Function(_$_CollectionMethodDTO) _then)
      : super(_value, (v) => _then(v as _$_CollectionMethodDTO));

  @override
  _$_CollectionMethodDTO get _value => super._value as _$_CollectionMethodDTO;
  ...
  $Res call({
    ...
    return _then(_$_CollectionMethodDTO(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_CollectionMethodDTO extends _CollectionMethodDTO {
  const _$_CollectionMethodDTO(
      {@JsonKey(name: 'METODO_COBRO_ID') required this.id,
  ...
  factory _$_CollectionMethodDTO.fromJson(Map<String, dynamic> json) =>
      _$$_CollectionMethodDTOFromJson(json);
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_CollectionMethodDTO &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_CollectionMethodDTOCopyWith<_$_CollectionMethodDTO> get copyWith =>
      __$$_CollectionMethodDTOCopyWithImpl<_$_CollectionMethodDTO>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CollectionMethodDTOToJson(
      this,
    );
  }
}

abstract class _CollectionMethodDTO extends CollectionMethodDTO {
  const factory _CollectionMethodDTO(
      {@JsonKey(name: 'METODO_COBRO_ID') required final String id,
      ...
      @JsonKey(name: 'DELETED') final String deleted}) = _$_CollectionMethodDTO;
  const _CollectionMethodDTO._() : super._();

  factory _CollectionMethodDTO.fromJson(Map<String, dynamic> json) =
      _$_CollectionMethodDTO.fromJson;
