...
_$_CollectionTermDTO _$$_CollectionTermDTOFromJson(Map<String, dynamic> json) =>
    _$_CollectionTermDTO(
...
Map<String, dynamic> _$$_CollectionTermDTOToJson(
        _$_CollectionTermDTO instance) =>
    <String, dynamic>{
