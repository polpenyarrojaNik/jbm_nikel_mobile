...
_$_CollectionMethodDTO _$$_CollectionMethodDTOFromJson(
        Map<String, dynamic> json) =>
    _$_CollectionMethodDTO(
...
Map<String, dynamic> _$$_CollectionMethodDTOToJson(
        _$_CollectionMethodDTO instance) =>
    <String, dynamic>{
