...
part of 'collection_term_dto.dart';
...
CollectionTermDTO _$CollectionTermDTOFromJson(Map<String, dynamic> json) {
  return _CollectionTermDTO.fromJson(json);
}

/// @nodoc
mixin _$CollectionTermDTO {
  ...
  @JsonKey(ignore: true)
  $CollectionTermDTOCopyWith<CollectionTermDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $CollectionTermDTOCopyWith<$Res> {
  factory $CollectionTermDTOCopyWith(
          CollectionTermDTO value, $Res Function(CollectionTermDTO) then) =
      _$CollectionTermDTOCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'PLAZO_COBRO_ID') String id,
...
/// @nodoc
class _$CollectionTermDTOCopyWithImpl<$Res>
    implements $CollectionTermDTOCopyWith<$Res> {
  _$CollectionTermDTOCopyWithImpl(this._value, this._then);

  final CollectionTermDTO _value;
  // ignore: unused_field
  final $Res Function(CollectionTermDTO) _then;
...
/// @nodoc
abstract class _$$_CollectionTermDTOCopyWith<$Res>
    implements $CollectionTermDTOCopyWith<$Res> {
  factory _$$_CollectionTermDTOCopyWith(_$_CollectionTermDTO value,
          $Res Function(_$_CollectionTermDTO) then) =
      __$$_CollectionTermDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'PLAZO_COBRO_ID') String id,
      @JsonKey(name: 'DESCRIPCION_ES') String descriptionES,
...
/// @nodoc
class __$$_CollectionTermDTOCopyWithImpl<$Res>
    extends _$CollectionTermDTOCopyWithImpl<$Res>
    implements _$$_CollectionTermDTOCopyWith<$Res> {
  __$$_CollectionTermDTOCopyWithImpl(
      _$_CollectionTermDTO _value, $Res Function(_$_CollectionTermDTO) _then)
      : super(_value, (v) => _then(v as _$_CollectionTermDTO));

  @override
  _$_CollectionTermDTO get _value => super._value as _$_CollectionTermDTO;
  ...
  $Res call({
    ...
    return _then(_$_CollectionTermDTO(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_CollectionTermDTO extends _CollectionTermDTO {
  const _$_CollectionTermDTO(
  ...
  factory _$_CollectionTermDTO.fromJson(Map<String, dynamic> json) =>
      _$$_CollectionTermDTOFromJson(json);
  ...
  @JsonKey(ignore: true)
  @override
  _$$_CollectionTermDTOCopyWith<_$_CollectionTermDTO> get copyWith =>
      __$$_CollectionTermDTOCopyWithImpl<_$_CollectionTermDTO>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_CollectionTermDTOToJson(
      this,
    );
  }
}

abstract class _CollectionTermDTO extends CollectionTermDTO {
  const factory _CollectionTermDTO(
      {@JsonKey(name: 'PLAZO_COBRO_ID') required final String id,
      ...
      @JsonKey(name: 'DELETED') final String deleted}) = _$_CollectionTermDTO;
  const _CollectionTermDTO._() : super._();

  factory _CollectionTermDTO.fromJson(Map<String, dynamic> json) =
      _$_CollectionTermDTO.fromJson;
