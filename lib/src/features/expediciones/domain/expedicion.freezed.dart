...
int get hashCode {
  final _this = this as Expedicion;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoVentaId,_this.usuarioId,_this.pedidoVentaDate,_this.clienteId,_this.direccionId,_this.nombreCliente,_this.codigoPostal,_this.poblacion,_this.provincia,_this.pais,_this.divisa,_this.baseImponible,_this.pedidoVentaEstado,_this.oferta,_this.pedidoAppId,_this.numLineas,_this.trackingEstado,_this.albaranId,_this.trackId,_this.agencia,_this.fechaAlbaran,_this.enviada,_this.tratada,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as Expedicion;
  return 'Expedicion(empresaId: ${_this.empresaId}, pedidoVentaId: ${_this.pedidoVentaId}, usuarioId: ${_this.usuarioId}, pedidoVentaDate: ${_this.pedidoVentaDate}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombreCliente: ${_this.nombreCliente}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, pais: ${_this.pais}, divisa: ${_this.divisa}, baseImponible: ${_this.baseImponible}, pedidoVentaEstado: ${_this.pedidoVentaEstado}, oferta: ${_this.oferta}, pedidoAppId: ${_this.pedidoAppId}, numLineas: ${_this.numLineas}, trackingEstado: ${_this.trackingEstado}, albaranId: ${_this.albaranId}, trackId: ${_this.trackId}, agencia: ${_this.agencia}, fechaAlbaran: ${_this.fechaAlbaran}, enviada: ${_this.enviada}, tratada: ${_this.tratada}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,empresaId,pedidoVentaId,usuarioId,pedidoVentaDate,clienteId,direccionId,nombreCliente,codigoPostal,poblacion,provincia,pais,divisa,baseImponible,pedidoVentaEstado,oferta,pedidoAppId,numLineas,trackingEstado,albaranId,trackId,agencia,fechaAlbaran,enviada,tratada,lastUpdated,deleted]);
}
