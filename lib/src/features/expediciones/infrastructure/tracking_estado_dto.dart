...
class TrackingEstadoDTO
  ...
  const factory TrackingEstadoDTO({
    @JsonKey(name: 'TRACKING_ESTADO') required String id,
  ...
  factory TrackingEstadoDTO.fromJson(Map<String, dynamic> json) =>
      _$TrackingEstadoDTOFromJson(json);

  TrackingEstado toDomain() {
    return TrackingEstado(
        id: id,
...
@UseRowClass(TrackingEstadoDTO)
class TrackingEstadoTable extends Table {
  @override
  String get tableName => 'TRACKING_ESTADO';

  @override
  Set<Column> get primaryKey => {id};

  TextColumn get id => text().named('TRACKING_ESTADO')();
