...
int get hashCode {
  final _this = this as ExpedicionDTO;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoVentaId,_this.pedidoVentaDate,_this.clienteId,_this.direccionId,_this.nombreCliente,_this.codigoPostal,_this.poblacion,_this.provincia,_this.paisId,_this.divisaId,_this.baseImponible,_this.pedidoVentaEstadoId,_this.numLineas,_this.estadoTrackingId,_this.albaranId,_this.trackId,_this.agencia,_this.fechaAlbaran,_this.oferta,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as ExpedicionDTO;
  return 'ExpedicionDTO(empresaId: ${_this.empresaId}, pedidoVentaId: ${_this.pedidoVentaId}, pedidoVentaDate: ${_this.pedidoVentaDate}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombreCliente: ${_this.nombreCliente}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, paisId: ${_this.paisId}, divisaId: ${_this.divisaId}, baseImponible: ${_this.baseImponible}, pedidoVentaEstadoId: ${_this.pedidoVentaEstadoId}, numLineas: ${_this.numLineas}, estadoTrackingId: ${_this.estadoTrackingId}, albaranId: ${_this.albaranId}, trackId: ${_this.trackId}, agencia: ${_this.agencia}, fechaAlbaran: ${_this.fechaAlbaran}, oferta: ${_this.oferta}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,empresaId,pedidoVentaId,pedidoVentaDate,clienteId,direccionId,nombreCliente,codigoPostal,poblacion,provincia,paisId,divisaId,baseImponible,pedidoVentaEstadoId,numLineas,estadoTrackingId,albaranId,trackId,agencia,fechaAlbaran,oferta,lastUpdated,deleted]);
}
