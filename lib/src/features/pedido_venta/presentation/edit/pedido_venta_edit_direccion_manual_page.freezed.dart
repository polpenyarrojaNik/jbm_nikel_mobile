...
@pragma('vm:prefer-inline') @override $Res call({Object? paises = null,Object? provincias = null,}) {
  return _then(DireccionManualScreenData(
...
class _DireccionManualScreenData extends DireccionManualScreenData {
  const _DireccionManualScreenData({required  List<Pais> paises, required  List<Provincia> provincias}): _paises = paises,_provincias = provincias,super._();
