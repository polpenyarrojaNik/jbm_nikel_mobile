...
bool operator ==(Object other) {
  final _this = this as PedidoVentaLocalDTO;
...
int get hashCode {
  final _this = this as PedidoVentaLocalDTO;
  return Object.hashAll([runtimeType,_this.usuarioId,_this.pedidoId,_this.empresaId,_this.pedidoVentaAppId,_this.clienteId,_this.nombreCliente,_this.direccionId,_this.direccion1,_this.direccion2,_this.codigoPostal,_this.poblacion,_this.provincia,_this.paisId,_this.divisaId,_this.pedidoCliente,_this.observaciones,_this.oferta,_this.ofertaFechaHasta,_this.fechaAlta,_this.iva,_this.dtoBonificacion,_this.enviada,_this.tratada,_this.borrador,_this.errorSyncMessage]);
}

@override
String toString() {
  final _this = this as PedidoVentaLocalDTO;
  return 'PedidoVentaLocalDTO(usuarioId: ${_this.usuarioId}, pedidoId: ${_this.pedidoId}, empresaId: ${_this.empresaId}, pedidoVentaAppId: ${_this.pedidoVentaAppId}, clienteId: ${_this.clienteId}, nombreCliente: ${_this.nombreCliente}, direccionId: ${_this.direccionId}, direccion1: ${_this.direccion1}, direccion2: ${_this.direccion2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, paisId: ${_this.paisId}, divisaId: ${_this.divisaId}, pedidoCliente: ${_this.pedidoCliente}, observaciones: ${_this.observaciones}, oferta: ${_this.oferta}, ofertaFechaHasta: ${_this.ofertaFechaHasta}, fechaAlta: ${_this.fechaAlta}, iva: ${_this.iva}, dtoBonificacion: ${_this.dtoBonificacion}, enviada: ${_this.enviada}, tratada: ${_this.tratada}, borrador: ${_this.borrador}, errorSyncMessage: ${_this.errorSyncMessage})';
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? usuarioId = freezed,Object? pedidoId = freezed,Object? empresaId = freezed,Object? pedidoVentaAppId = null,Object? clienteId = null,Object? nombreCliente = null,Object? direccionId = freezed,Object? direccion1 = freezed,Object? direccion2 = freezed,Object? codigoPostal = freezed,Object? poblacion = freezed,Object? provincia = freezed,Object? paisId = freezed,Object? divisaId = freezed,Object? pedidoCliente = freezed,Object? observaciones = freezed,Object? oferta = null,Object? ofertaFechaHasta = freezed,Object? fechaAlta = null,Object? iva = null,Object? dtoBonificacion = null,Object? enviada = null,Object? tratada = null,Object? borrador = null,Object? errorSyncMessage = freezed,}) {
  return _then(PedidoVentaLocalDTO(
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,usuarioId,pedidoId,empresaId,pedidoVentaAppId,clienteId,nombreCliente,direccionId,direccion1,direccion2,codigoPostal,poblacion,provincia,paisId,divisaId,pedidoCliente,observaciones,oferta,ofertaFechaHasta,fechaAlta,iva,dtoBonificacion,enviada,tratada,borrador,errorSyncMessage]);
}
