...
_$_PedidoVentaLineaLocalDTO _$$_PedidoVentaLineaLocalDTOFromJson(
    ...
    _$_PedidoVentaLineaLocalDTO(
      ...
      tipoPrecio: (json['TPRECIO'] as num).toDouble(),
...
Map<String, dynamic> _$$_PedidoVentaLineaLocalDTOToJson(
        _$_PedidoVentaLineaLocalDTO instance) =>
    <String, dynamic>{
