...
int get hashCode {
  final _this = this as PedidoVentaLineaLocalDTO;
  return Object.hashAll([runtimeType,_this.pedidoVentaAppId,_this.empresaId,_this.pedidoId,_this.pedidoVentaLineaAppId,_this.articuloId,_this.articuloDescription,_this.cantidad,_this.precioDivisa,_this.tipoPrecio,_this.descuento1,_this.descuento2,_this.descuento3,_this.descuentoProntoPago,_this.stockDisponibleSN,_this.fechaDisponible,_this.iva,_this.pedidoLineaComponenteId,_this.aiRecomendado,_this.codPromo,_this.cantidadPromo,_this.promoSN]);
}

@override
String toString() {
  final _this = this as PedidoVentaLineaLocalDTO;
  return 'PedidoVentaLineaLocalDTO(pedidoVentaAppId: ${_this.pedidoVentaAppId}, empresaId: ${_this.empresaId}, pedidoId: ${_this.pedidoId}, pedidoVentaLineaAppId: ${_this.pedidoVentaLineaAppId}, articuloId: ${_this.articuloId}, articuloDescription: ${_this.articuloDescription}, cantidad: ${_this.cantidad}, precioDivisa: ${_this.precioDivisa}, tipoPrecio: ${_this.tipoPrecio}, descuento1: ${_this.descuento1}, descuento2: ${_this.descuento2}, descuento3: ${_this.descuento3}, descuentoProntoPago: ${_this.descuentoProntoPago}, stockDisponibleSN: ${_this.stockDisponibleSN}, fechaDisponible: ${_this.fechaDisponible}, iva: ${_this.iva}, pedidoLineaComponenteId: ${_this.pedidoLineaComponenteId}, aiRecomendado: ${_this.aiRecomendado}, codPromo: ${_this.codPromo}, cantidadPromo: ${_this.cantidadPromo}, promoSN: ${_this.promoSN})';
}
...
as String?,aiRecomendado: null == aiRecomendado ? _self.aiRecomendado : aiRecomendado // ignore: cast_nullable_to_non_nullable
as String,codPromo: freezed == codPromo ? _self.codPromo : codPromo // ignore: cast_nullable_to_non_nullable
as String?,cantidadPromo: freezed == cantidadPromo ? _self.cantidadPromo : cantidadPromo // ignore: cast_nullable_to_non_nullable
as int?,promoSN: freezed == promoSN ? _self.promoSN : promoSN // ignore: cast_nullable_to_non_nullable
as String?,
  ));
}
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'PEDIDO_APP_ID')  String pedidoVentaAppId, @JsonKey(name: 'EMPRESA_ID')  String? empresaId, @JsonKey(name: 'PEDIDO_ID')  String? pedidoId, @JsonKey(name: 'LIN_APP_ID')  String pedidoVentaLineaAppId, @JsonKey(name: 'PRODUCTO_ID')  String articuloId, @JsonKey(name: 'DENOMINACION')  String articuloDescription, @JsonKey(name: 'CANTIDAD')  int cantidad, @JsonKey(name: 'PRECIO_DIVISA')  double precioDivisa, @JsonKey(name: 'TPRECIO')  int tipoPrecio, @JsonKey(name: 'DTO1')  double descuento1, @JsonKey(name: 'DTO2')  double descuento2, @JsonKey(name: 'DTO3')  double descuento3, @JsonKey(name: 'DTO_PP')  double descuentoProntoPago, @JsonKey(name: 'STOCK_DISPONIBLE_SN')  String stockDisponibleSN, @JsonKey(name: 'F_DISPONIBLE')  DateTime? fechaDisponible, @JsonKey(name: 'IVA')  double iva, @JsonKey(name: 'PEDIDO_LINEA_ID_COMPONENTE')  String? pedidoLineaComponenteId, @JsonKey(name: 'AI_RECOMENDADO')  String aiRecomendado, @JsonKey(name: 'COD_PROMO')  String? codPromo, @JsonKey(name: 'PROMO_CANTIDAD')  int? cantidadPromo, @JsonKey(name: 'PROMO_SN')  String? promoSN)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PedidoVentaLineaLocalDTO() when $default != null:
return $default(_that.pedidoVentaAppId,_that.empresaId,_that.pedidoId,_that.pedidoVentaLineaAppId,_that.articuloId,_that.articuloDescription,_that.cantidad,_that.precioDivisa,_that.tipoPrecio,_that.descuento1,_that.descuento2,_that.descuento3,_that.descuentoProntoPago,_that.stockDisponibleSN,_that.fechaDisponible,_that.iva,_that.pedidoLineaComponenteId,_that.aiRecomendado,_that.codPromo,_that.cantidadPromo,_that.promoSN);case _:
  return orElse();
...
@override@JsonKey(name: 'AI_RECOMENDADO') final  String aiRecomendado;
@override@JsonKey(name: 'COD_PROMO') final  String? codPromo;
@override@JsonKey(name: 'PROMO_CANTIDAD') final  int? cantidadPromo;
@override@JsonKey(name: 'PROMO_SN') final  String? promoSN;
