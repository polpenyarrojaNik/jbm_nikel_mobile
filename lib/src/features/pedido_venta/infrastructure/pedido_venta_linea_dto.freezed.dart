...
@JsonKey(name: 'EMPRESA_ID') String get empresaId;@JsonKey(name: 'PEDIDO_ID') String get pedidoId;@JsonKey(name: 'PEDIDO_LINEA_ID') String get pedidoVentaLineaId;@JsonKey(name: 'ARTICULO_ID') String get articuloId;@JsonKey(name: 'ARTICULO_DESCRIPCION') String get articuloDescription;@JsonKey(name: 'CANTIDAD') int get cantidad;@JsonKey(name: 'PRECIO_DIVISA') double get precioDivisa;@JsonKey(name: 'TIPO_PRECIO') int get tipoPrecio;@JsonKey(name: 'DESCUENTO1') double get descuento1;@JsonKey(name: 'DESCUENTO2') double get descuento2;@JsonKey(name: 'DESCUENTO3') double get descuento3;@JsonKey(name: 'PEDIDO_LINEA_ID_COMPONENTE') String? get pedidoLineaIdComponente;@JsonKey(name: 'TOTAL_LINEA') double? get importeLinea;@JsonKey(name: 'CANTIDAD_SERVIDA') int get cantidadServida;@JsonKey(name: 'COD_PROMO') String? get codPromo;@JsonKey(name: 'PROMO_CANTIDAD') int? get cantidadPromo;@JsonKey(name: 'PROMO_SN') String? get promoSN;@JsonKey(name: 'LAST_UPDATED') DateTime get lastUpdated;@JsonKey(name: 'DELETED') String get deleted;
...
int get hashCode {
  final _this = this as PedidoVentaLineaDTO;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoId,_this.pedidoVentaLineaId,_this.articuloId,_this.articuloDescription,_this.cantidad,_this.precioDivisa,_this.tipoPrecio,_this.descuento1,_this.descuento2,_this.descuento3,_this.pedidoLineaIdComponente,_this.importeLinea,_this.cantidadServida,_this.codPromo,_this.cantidadPromo,_this.promoSN,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as PedidoVentaLineaDTO;
  return 'PedidoVentaLineaDTO(empresaId: ${_this.empresaId}, pedidoId: ${_this.pedidoId}, pedidoVentaLineaId: ${_this.pedidoVentaLineaId}, articuloId: ${_this.articuloId}, articuloDescription: ${_this.articuloDescription}, cantidad: ${_this.cantidad}, precioDivisa: ${_this.precioDivisa}, tipoPrecio: ${_this.tipoPrecio}, descuento1: ${_this.descuento1}, descuento2: ${_this.descuento2}, descuento3: ${_this.descuento3}, pedidoLineaIdComponente: ${_this.pedidoLineaIdComponente}, importeLinea: ${_this.importeLinea}, cantidadServida: ${_this.cantidadServida}, codPromo: ${_this.codPromo}, cantidadPromo: ${_this.cantidadPromo}, promoSN: ${_this.promoSN}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
as int,codPromo: freezed == codPromo ? _self.codPromo : codPromo // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'EMPRESA_ID')  String empresaId, @JsonKey(name: 'PEDIDO_ID')  String pedidoId, @JsonKey(name: 'PEDIDO_LINEA_ID')  String pedidoVentaLineaId, @JsonKey(name: 'ARTICULO_ID')  String articuloId, @JsonKey(name: 'ARTICULO_DESCRIPCION')  String articuloDescription, @JsonKey(name: 'CANTIDAD')  int cantidad, @JsonKey(name: 'PRECIO_DIVISA')  double precioDivisa, @JsonKey(name: 'TIPO_PRECIO')  int tipoPrecio, @JsonKey(name: 'DESCUENTO1')  double descuento1, @JsonKey(name: 'DESCUENTO2')  double descuento2, @JsonKey(name: 'DESCUENTO3')  double descuento3, @JsonKey(name: 'PEDIDO_LINEA_ID_COMPONENTE')  String? pedidoLineaIdComponente, @JsonKey(name: 'TOTAL_LINEA')  double? importeLinea, @JsonKey(name: 'CANTIDAD_SERVIDA')  int cantidadServida, @JsonKey(name: 'COD_PROMO')  String? codPromo, @JsonKey(name: 'PROMO_CANTIDAD')  int? cantidadPromo, @JsonKey(name: 'PROMO_SN')  String? promoSN, @JsonKey(name: 'LAST_UPDATED')  DateTime lastUpdated, @JsonKey(name: 'DELETED')  String deleted)  $default,) {final _that = this;
switch (_that) {
case _PedidoVentaLineaDTO():
return $default(_that.empresaId,_that.pedidoId,_that.pedidoVentaLineaId,_that.articuloId,_that.articuloDescription,_that.cantidad,_that.precioDivisa,_that.tipoPrecio,_that.descuento1,_that.descuento2,_that.descuento3,_that.pedidoLineaIdComponente,_that.importeLinea,_that.cantidadServida,_that.codPromo,_that.cantidadPromo,_that.promoSN,_that.lastUpdated,_that.deleted);case _:
  throw StateError('Unexpected subclass');
