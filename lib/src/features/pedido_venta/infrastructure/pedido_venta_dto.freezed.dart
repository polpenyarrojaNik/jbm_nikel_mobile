...
int get hashCode {
  final _this = this as PedidoVentaDTO;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoVentaId,_this.pedidoVentaDate,_this.tipoVenta,_this.clienteId,_this.direccionId,_this.nombreCliente,_this.direccionEntrga1,_this.direccionEntrga2,_this.codigoPostal,_this.poblacion,_this.provincia,_this.paisId,_this.divisaId,_this.baseImponible,_this.totalLineas,_this.importePortes,_this.importeIva,_this.total,_this.pedidoVentaEstadoId,_this.oferta,_this.ofertaFechaHasta,_this.pedidoVentaAppId,_this.iva,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as PedidoVentaDTO;
  return 'PedidoVentaDTO(empresaId: ${_this.empresaId}, pedidoVentaId: ${_this.pedidoVentaId}, pedidoVentaDate: ${_this.pedidoVentaDate}, tipoVenta: ${_this.tipoVenta}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombreCliente: ${_this.nombreCliente}, direccionEntrga1: ${_this.direccionEntrga1}, direccionEntrga2: ${_this.direccionEntrga2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, provincia: ${_this.provincia}, paisId: ${_this.paisId}, divisaId: ${_this.divisaId}, baseImponible: ${_this.baseImponible}, totalLineas: ${_this.totalLineas}, importePortes: ${_this.importePortes}, importeIva: ${_this.importeIva}, total: ${_this.total}, pedidoVentaEstadoId: ${_this.pedidoVentaEstadoId}, oferta: ${_this.oferta}, ofertaFechaHasta: ${_this.ofertaFechaHasta}, pedidoVentaAppId: ${_this.pedidoVentaAppId}, iva: ${_this.iva}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hashAll([runtimeType,empresaId,pedidoVentaId,pedidoVentaDate,tipoVenta,clienteId,direccionId,nombreCliente,direccionEntrga1,direccionEntrga2,codigoPostal,poblacion,provincia,paisId,divisaId,baseImponible,totalLineas,importePortes,importeIva,total,pedidoVentaEstadoId,oferta,ofertaFechaHasta,pedidoVentaAppId,iva,lastUpdated,deleted]);
}
