...
int get hashCode {
  final _this = this as PedidoVentaLinea;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoId,_this.pedidoVentaLineaId,_this.pedidoVentaAppId,_this.articuloId,_this.articuloDescription,_this.cantidad,_this.precioDivisa,_this.divisaId,_this.tipoPrecio,_this.descuento1,_this.descuento2,_this.descuento3,_this.descuentoProntoPago,_this.pedidoLineaIdComponente,_this.importeLinea,_this.stockDisponibleSN,_this.stockDisponible,_this.fechaDisponible,_this.iva,_this.aiRecomendado,_this.cantidadPendiente,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as PedidoVentaLinea;
  return 'PedidoVentaLinea(empresaId: ${_this.empresaId}, pedidoId: ${_this.pedidoId}, pedidoVentaLineaId: ${_this.pedidoVentaLineaId}, pedidoVentaAppId: ${_this.pedidoVentaAppId}, articuloId: ${_this.articuloId}, articuloDescription: ${_this.articuloDescription}, cantidad: ${_this.cantidad}, precioDivisa: ${_this.precioDivisa}, divisaId: ${_this.divisaId}, tipoPrecio: ${_this.tipoPrecio}, descuento1: ${_this.descuento1}, descuento2: ${_this.descuento2}, descuento3: ${_this.descuento3}, descuentoProntoPago: ${_this.descuentoProntoPago}, pedidoLineaIdComponente: ${_this.pedidoLineaIdComponente}, importeLinea: ${_this.importeLinea}, stockDisponibleSN: ${_this.stockDisponibleSN}, stockDisponible: ${_this.stockDisponible}, fechaDisponible: ${_this.fechaDisponible}, iva: ${_this.iva}, aiRecomendado: ${_this.aiRecomendado}, cantidadPendiente: ${_this.cantidadPendiente}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
switch (_that) {
case _PedidoVentaLinea() when $default != null:
return $default(_that.empresaId,_that.pedidoId,_that.pedidoVentaLineaId,_that.pedidoVentaAppId,_that.articuloId,_that.articuloDescription,_that.cantidad,_that.precioDivisa,_that.divisaId,_that.tipoPrecio,_that.descuento1,_that.descuento2,_that.descuento3,_that.descuentoProntoPago,_that.pedidoLineaIdComponente,_that.importeLinea,_that.stockDisponibleSN,_that.stockDisponible,_that.fechaDisponible,_that.iva,_that.aiRecomendado,_that.cantidadPendiente,_that.lastUpdated,_that.deleted);case _:
  return orElse();
