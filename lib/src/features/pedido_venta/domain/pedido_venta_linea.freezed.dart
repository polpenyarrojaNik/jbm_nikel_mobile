...
mixin _$PedidoVentaLinea {
 ...
 String? get empresaId; String? get pedidoId; String? get pedidoVentaLineaId; String? get pedidoVentaAppId; String get articuloId; String get articuloDescription; int get cantidad; Money get precioDivisa; String get divisaId; int get tipoPrecio; double get descuento1; double get descuento2; double get descuento3; double? get descuentoProntoPago; String? get pedidoLineaIdComponente; Money? get importeLinea; bool? get stockDisponibleSN; int? get stockDisponible; DateTime? get fechaDisponible; double? get iva; bool get aiRecomendado; int get cantidadPendiente; DateTime get lastUpdated; String? get codPromo; int? get cantidadPromo; bool? get isPromo; bool get deleted;
...
int get hashCode {
  final _this = this as PedidoVentaLinea;
  return Object.hashAll([runtimeType,_this.empresaId,_this.pedidoId,_this.pedidoVentaLineaId,_this.pedidoVentaAppId,_this.articuloId,_this.articuloDescription,_this.cantidad,_this.precioDivisa,_this.divisaId,_this.tipoPrecio,_this.descuento1,_this.descuento2,_this.descuento3,_this.descuentoProntoPago,_this.pedidoLineaIdComponente,_this.importeLinea,_this.stockDisponibleSN,_this.stockDisponible,_this.fechaDisponible,_this.iva,_this.aiRecomendado,_this.cantidadPendiente,_this.lastUpdated,_this.codPromo,_this.cantidadPromo,_this.isPromo,_this.deleted]);
}

@override
String toString() {
  final _this = this as PedidoVentaLinea;
  return 'PedidoVentaLinea(empresaId: ${_this.empresaId}, pedidoId: ${_this.pedidoId}, pedidoVentaLineaId: ${_this.pedidoVentaLineaId}, pedidoVentaAppId: ${_this.pedidoVentaAppId}, articuloId: ${_this.articuloId}, articuloDescription: ${_this.articuloDescription}, cantidad: ${_this.cantidad}, precioDivisa: ${_this.precioDivisa}, divisaId: ${_this.divisaId}, tipoPrecio: ${_this.tipoPrecio}, descuento1: ${_this.descuento1}, descuento2: ${_this.descuento2}, descuento3: ${_this.descuento3}, descuentoProntoPago: ${_this.descuentoProntoPago}, pedidoLineaIdComponente: ${_this.pedidoLineaIdComponente}, importeLinea: ${_this.importeLinea}, stockDisponibleSN: ${_this.stockDisponibleSN}, stockDisponible: ${_this.stockDisponible}, fechaDisponible: ${_this.fechaDisponible}, iva: ${_this.iva}, aiRecomendado: ${_this.aiRecomendado}, cantidadPendiente: ${_this.cantidadPendiente}, lastUpdated: ${_this.lastUpdated}, codPromo: ${_this.codPromo}, cantidadPromo: ${_this.cantidadPromo}, isPromo: ${_this.isPromo}, deleted: ${_this.deleted})';
}
...
as double?,aiRecomendado: null == aiRecomendado ? _self.aiRecomendado : aiRecomendado // ignore: cast_nullable_to_non_nullable
as bool,cantidadPendiente: null == cantidadPendiente ? _self.cantidadPendiente : cantidadPendiente // ignore: cast_nullable_to_non_nullable
as int,lastUpdated: null == lastUpdated ? _self.lastUpdated : lastUpdated // ignore: cast_nullable_to_non_nullable
as DateTime,codPromo: freezed == codPromo ? _self.codPromo : codPromo // ignore: cast_nullable_to_non_nullable
as String?,cantidadPromo: freezed == cantidadPromo ? _self.cantidadPromo : cantidadPromo // ignore: cast_nullable_to_non_nullable
as int?,isPromo: freezed == isPromo ? _self.isPromo : isPromo // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? empresaId,  String? pedidoId,  String? pedidoVentaLineaId,  String? pedidoVentaAppId,  String articuloId,  String articuloDescription,  int cantidad,  Money precioDivisa,  String divisaId,  int tipoPrecio,  double descuento1,  double descuento2,  double descuento3,  double? descuentoProntoPago,  String? pedidoLineaIdComponente,  Money? importeLinea,  bool? stockDisponibleSN,  int? stockDisponible,  DateTime? fechaDisponible,  double? iva,  bool aiRecomendado,  int cantidadPendiente,  DateTime lastUpdated,  String? codPromo,  int? cantidadPromo,  bool? isPromo,  bool deleted)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PedidoVentaLinea() when $default != null:
return $default(_that.empresaId,_that.pedidoId,_that.pedidoVentaLineaId,_that.pedidoVentaAppId,_that.articuloId,_that.articuloDescription,_that.cantidad,_that.precioDivisa,_that.divisaId,_that.tipoPrecio,_that.descuento1,_that.descuento2,_that.descuento3,_that.descuentoProntoPago,_that.pedidoLineaIdComponente,_that.importeLinea,_that.stockDisponibleSN,_that.stockDisponible,_that.fechaDisponible,_that.iva,_that.aiRecomendado,_that.cantidadPendiente,_that.lastUpdated,_that.codPromo,_that.cantidadPromo,_that.isPromo,_that.deleted);case _:
  return orElse();
...
@override final  bool aiRecomendado;
@override final  int cantidadPendiente;
@override final  DateTime lastUpdated;
@override final  String? codPromo;
@override final  int? cantidadPromo;
