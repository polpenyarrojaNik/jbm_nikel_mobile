...
part 'sales_order_status_dto.freezed.dart';
part 'sales_order_status_dto.g.dart';

// ignore_for_file: invalid_annotation_target

@freezed
class SalesOrderStatusDTO
    with _$SalesOrderStatusDTO
  ...
  }) = _SalesOrderStatusDTO;

  factory SalesOrderStatusDTO.fromJson(Map<String, dynamic> json) =>
      _$SalesOrderStatusDTOFromJson(json);

  SalesOrderStatus toDomain() {
...
@UseRowClass(SalesOrderStatusDTO)
class SalesOrderStatusTable extends Table {
  @override
