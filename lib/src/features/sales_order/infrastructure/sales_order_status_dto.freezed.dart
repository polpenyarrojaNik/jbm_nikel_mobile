...
SalesOrderStatusDTO _$SalesOrderStatusDTOFromJson(Map<String, dynamic> json) {
  return _SalesOrderStatusDTO.fromJson(json);
}

/// @nodoc
mixin _$SalesOrderStatusDTO {
  ...
  @JsonKey(ignore: true)
  $SalesOrderStatusDTOCopyWith<SalesOrderStatusDTO> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $SalesOrderStatusDTOCopyWith<$Res> {
  factory $SalesOrderStatusDTOCopyWith(
          SalesOrderStatusDTO value, $Res Function(SalesOrderStatusDTO) then) =
      _$SalesOrderStatusDTOCopyWithImpl<$Res>;
  $Res call(
      {@JsonKey(name: 'EStADO_PEDIDO_ID') String id,
...
/// @nodoc
class _$SalesOrderStatusDTOCopyWithImpl<$Res>
    implements $SalesOrderStatusDTOCopyWith<$Res> {
  _$SalesOrderStatusDTOCopyWithImpl(this._value, this._then);

  final SalesOrderStatusDTO _value;
  // ignore: unused_field
  final $Res Function(SalesOrderStatusDTO) _then;
...
/// @nodoc
abstract class _$$_SalesOrderStatusDTOCopyWith<$Res>
    implements $SalesOrderStatusDTOCopyWith<$Res> {
  factory _$$_SalesOrderStatusDTOCopyWith(_$_SalesOrderStatusDTO value,
          $Res Function(_$_SalesOrderStatusDTO) then) =
      __$$_SalesOrderStatusDTOCopyWithImpl<$Res>;
  @override
  $Res call(
      {@JsonKey(name: 'EStADO_PEDIDO_ID') String id,
      @JsonKey(name: 'DESCRIPCION_ES') String descriptionES,
...
/// @nodoc
class __$$_SalesOrderStatusDTOCopyWithImpl<$Res>
    extends _$SalesOrderStatusDTOCopyWithImpl<$Res>
    implements _$$_SalesOrderStatusDTOCopyWith<$Res> {
  __$$_SalesOrderStatusDTOCopyWithImpl(_$_SalesOrderStatusDTO _value,
      $Res Function(_$_SalesOrderStatusDTO) _then)
      : super(_value, (v) => _then(v as _$_SalesOrderStatusDTO));

  @override
  _$_SalesOrderStatusDTO get _value => super._value as _$_SalesOrderStatusDTO;
  ...
  $Res call({
    ...
    return _then(_$_SalesOrderStatusDTO(
      id: id == freezed
          ? _value.id
          : id // ignore: cast_nullable_to_non_nullable
              as String,
...
/// @nodoc
@JsonSerializable()
class _$_SalesOrderStatusDTO extends _SalesOrderStatusDTO {
  const _$_SalesOrderStatusDTO(
  ...
  factory _$_SalesOrderStatusDTO.fromJson(Map<String, dynamic> json) =>
      _$$_SalesOrderStatusDTOFromJson(json);
...
// @JsonKey(name: 'DESCRIPCION_PL') String? descriptionPL,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$_SalesOrderStatusDTO &&
  ...
  @JsonKey(ignore: true)
  @override
  _$$_SalesOrderStatusDTOCopyWith<_$_SalesOrderStatusDTO> get copyWith =>
      __$$_SalesOrderStatusDTOCopyWithImpl<_$_SalesOrderStatusDTO>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_SalesOrderStatusDTOToJson(
      this,
    );
  }
}

abstract class _SalesOrderStatusDTO extends SalesOrderStatusDTO {
  const factory _SalesOrderStatusDTO(
      {@JsonKey(name: 'EStADO_PEDIDO_ID') required final String id,
      ...
      @JsonKey(name: 'DELETED') final String deleted}) = _$_SalesOrderStatusDTO;
  const _SalesOrderStatusDTO._() : super._();

  factory _SalesOrderStatusDTO.fromJson(Map<String, dynamic> json) =
      _$_SalesOrderStatusDTO.fromJson;
