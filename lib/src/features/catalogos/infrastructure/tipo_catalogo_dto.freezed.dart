...
int get hashCode {
  final _this = this as TipoCatalogoDTO;
  return Object.hash(runtimeType,_this.tipoCatalogoId,_this.descripcionES,_this.descripcionEN,_this.descripcionFR,_this.descripcionDE,_this.descripcionCA,_this.descripcionGB,_this.descripcionHU,_this.descripcionIT,_this.descripcionNL,_this.descripcionPL);
}

@override
String toString() {
  final _this = this as TipoCatalogoDTO;
  return 'TipoCatalogoDTO(tipoCatalogoId: ${_this.tipoCatalogoId}, descripcionES: ${_this.descripcionES}, descripcionEN: ${_this.descripcionEN}, descripcionFR: ${_this.descripcionFR}, descripcionDE: ${_this.descripcionDE}, descripcionCA: ${_this.descripcionCA}, descripcionGB: ${_this.descripcionGB}, descripcionHU: ${_this.descripcionHU}, descripcionIT: ${_this.descripcionIT}, descripcionNL: ${_this.descripcionNL}, descripcionPL: ${_this.descripcionPL})';
}
...
/// @nodoc
class _$TipoCatalogoDTOCopyWithImpl<$Res>
    implements $TipoCatalogoDTOCopyWith<$Res> {
  _$TipoCatalogoDTOCopyWithImpl(this._self, this._then);

  final TipoCatalogoDTO _self;
  final $Res Function(TipoCatalogoDTO) _then;

/// Create a copy of TipoCatalogoDTO
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? tipoCatalogoId = null,Object? descripcionES = null,Object? descripcionEN = freezed,Object? descripcionFR = freezed,Object? descripcionDE = freezed,Object? descripcionCA = freezed,Object? descripcionGB = freezed,Object? descripcionHU = freezed,Object? descripcionIT = freezed,Object? descripcionNL = freezed,Object? descripcionPL = freezed,}) {
  return _then(TipoCatalogoDTO(
...
/// Adds pattern-matching-related methods to [TipoCatalogoDTO].
extension TipoCatalogoDTOPatterns on TipoCatalogoDTO {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _TipoCatalogoDTO value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _TipoCatalogoDTO() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _TipoCatalogoDTO value)  $default,){
final _that = this;
switch (_that) {
case _TipoCatalogoDTO():
return $default(_that);case _:
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _TipoCatalogoDTO value)?  $default,){
final _that = this;
switch (_that) {
case _TipoCatalogoDTO() when $default != null:
return $default(_that);case _:
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(name: 'TIPO_CATALOGO_ID')  String tipoCatalogoId, @JsonKey(name: 'DESCRIPCION_ES')  String descripcionES, @JsonKey(name: 'DESCRIPCION_EN')  String? descripcionEN, @JsonKey(name: 'DESCRIPCION_FR')  String? descripcionFR, @JsonKey(name: 'DESCRIPCION_DE')  String? descripcionDE, @JsonKey(name: 'DESCRIPCION_CA')  String? descripcionCA, @JsonKey(name: 'DESCRIPCION_GB')  String? descripcionGB, @JsonKey(name: 'DESCRIPCION_HU')  String? descripcionHU, @JsonKey(name: 'DESCRIPCION_IT')  String? descripcionIT, @JsonKey(name: 'DESCRIPCION_NL')  String? descripcionNL, @JsonKey(name: 'DESCRIPCION_PL')  String? descripcionPL)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TipoCatalogoDTO() when $default != null:
return $default(_that.tipoCatalogoId,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(name: 'TIPO_CATALOGO_ID')  String tipoCatalogoId, @JsonKey(name: 'DESCRIPCION_ES')  String descripcionES, @JsonKey(name: 'DESCRIPCION_EN')  String? descripcionEN, @JsonKey(name: 'DESCRIPCION_FR')  String? descripcionFR, @JsonKey(name: 'DESCRIPCION_DE')  String? descripcionDE, @JsonKey(name: 'DESCRIPCION_CA')  String? descripcionCA, @JsonKey(name: 'DESCRIPCION_GB')  String? descripcionGB, @JsonKey(name: 'DESCRIPCION_HU')  String? descripcionHU, @JsonKey(name: 'DESCRIPCION_IT')  String? descripcionIT, @JsonKey(name: 'DESCRIPCION_NL')  String? descripcionNL, @JsonKey(name: 'DESCRIPCION_PL')  String? descripcionPL)  $default,) {final _that = this;
switch (_that) {
case _TipoCatalogoDTO():
return $default(_that.tipoCatalogoId,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(name: 'TIPO_CATALOGO_ID')  String tipoCatalogoId, @JsonKey(name: 'DESCRIPCION_ES')  String descripcionES, @JsonKey(name: 'DESCRIPCION_EN')  String? descripcionEN, @JsonKey(name: 'DESCRIPCION_FR')  String? descripcionFR, @JsonKey(name: 'DESCRIPCION_DE')  String? descripcionDE, @JsonKey(name: 'DESCRIPCION_CA')  String? descripcionCA, @JsonKey(name: 'DESCRIPCION_GB')  String? descripcionGB, @JsonKey(name: 'DESCRIPCION_HU')  String? descripcionHU, @JsonKey(name: 'DESCRIPCION_IT')  String? descripcionIT, @JsonKey(name: 'DESCRIPCION_NL')  String? descripcionNL, @JsonKey(name: 'DESCRIPCION_PL')  String? descripcionPL)?  $default,) {final _that = this;
switch (_that) {
case _TipoCatalogoDTO() when $default != null:
return $default(_that.tipoCatalogoId,_that.descripcionES,_that.descripcionEN,_that.descripcionFR,_that.descripcionDE,_that.descripcionCA,_that.descripcionGB,_that.descripcionHU,_that.descripcionIT,_that.descripcionNL,_that.descripcionPL);case _:
  return null;
...
@pragma('vm:prefer-inline')
_$TipoCatalogoDTOCopyWith<_TipoCatalogoDTO> get copyWith => __$TipoCatalogoDTOCopyWithImpl<_TipoCatalogoDTO>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$TipoCatalogoDTOToJson(this, );
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,tipoCatalogoId,descripcionES,descripcionEN,descripcionFR,descripcionDE,descripcionCA,descripcionGB,descripcionHU,descripcionIT,descripcionNL,descripcionPL);
}

@override
String toString() {
    return 'TipoCatalogoDTO(tipoCatalogoId: $tipoCatalogoId, descripcionES: $descripcionES, descripcionEN: $descripcionEN, descripcionFR: $descripcionFR, descripcionDE: $descripcionDE, descripcionCA: $descripcionCA, descripcionGB: $descripcionGB, descripcionHU: $descripcionHU, descripcionIT: $descripcionIT, descripcionNL: $descripcionNL, descripcionPL: $descripcionPL)';
}
...
/// @nodoc
abstract mixin class _$TipoCatalogoDTOCopyWith<$Res> implements $TipoCatalogoDTOCopyWith<$Res> {
  factory _$TipoCatalogoDTOCopyWith(_TipoCatalogoDTO value, $Res Function(_TipoCatalogoDTO) _then) = __$TipoCatalogoDTOCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(name: 'TIPO_CATALOGO_ID') String tipoCatalogoId,@JsonKey(name: 'DESCRIPCION_ES') String descripcionES,@JsonKey(name: 'DESCRIPCION_EN') String? descripcionEN,@JsonKey(name: 'DESCRIPCION_FR') String? descripcionFR,@JsonKey(name: 'DESCRIPCION_DE') String? descripcionDE,@JsonKey(name: 'DESCRIPCION_CA') String? descripcionCA,@JsonKey(name: 'DESCRIPCION_GB') String? descripcionGB,@JsonKey(name: 'DESCRIPCION_HU') String? descripcionHU,@JsonKey(name: 'DESCRIPCION_IT') String? descripcionIT,@JsonKey(name: 'DESCRIPCION_NL') String? descripcionNL,@JsonKey(name: 'DESCRIPCION_PL') String? descripcionPL
});
...
/// @nodoc
class __$TipoCatalogoDTOCopyWithImpl<$Res>
    implements _$TipoCatalogoDTOCopyWith<$Res> {
  __$TipoCatalogoDTOCopyWithImpl(this._self, this._then);

  final _TipoCatalogoDTO _self;
  final $Res Function(_TipoCatalogoDTO) _then;

/// Create a copy of TipoCatalogoDTO
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? tipoCatalogoId = null,Object? descripcionES = null,Object? descripcionEN = freezed,Object? descripcionFR = freezed,Object? descripcionDE = freezed,Object? descripcionCA = freezed,Object? descripcionGB = freezed,Object? descripcionHU = freezed,Object? descripcionIT = freezed,Object? descripcionNL = freezed,Object? descripcionPL = freezed,}) {
  return _then(_TipoCatalogoDTO(
tipoCatalogoId: null == tipoCatalogoId ? _self.tipoCatalogoId : tipoCatalogoId // ignore: cast_nullable_to_non_nullable
as String,descripcionES: null == descripcionES ? _self.descripcionES : descripcionES // ignore: cast_nullable_to_non_nullable
as String,descripcionEN: freezed == descripcionEN ? _self.descripcionEN : descripcionEN // ignore: cast_nullable_to_non_nullable
as String?,descripcionFR: freezed == descripcionFR ? _self.descripcionFR : descripcionFR // ignore: cast_nullable_to_non_nullable
