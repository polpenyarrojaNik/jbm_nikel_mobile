...
part 'visita_sector_dto.freezed.dart';
part 'visita_sector_dto.g.dart';

// ignore_for_file: invalid_annotation_target

@freezed
abstract class VisitaSectorDTO
    with _$VisitaSectorDTO
    implements Insertable<VisitaSectorDTO> {
  const VisitaSectorDTO._();
  const factory VisitaSectorDTO({
  ...
  factory VisitaSectorDTO.fromJson(Map<String, dynamic> json) =>
      _$VisitaSectorDTOFromJson(json);

  VisitaSector toDomain() {
    return VisitaSector(
      id: id,
...
@UseRowClass(VisitaSectorDTO)
class VisitaSectorTable extends Table {
  @override
  String get tableName => 'VISITA_SECTORES';
