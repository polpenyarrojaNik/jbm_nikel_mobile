...
int get hashCode {
  final _this = this as VisitaDTO;
  return Object.hashAll([runtimeType,_this.id,_this.fecha,_this.clienteId,_this.isClienteProvisional,_this.clienteProvisionalNombre,_this.clienteProvisionalEmail,_this.clienteProvisionalTelefono,_this.clienteProvisionalPoblacion,_this.numEmpl,_this.contacto,_this.atendidoPor,_this.resumen,_this.marcasCompetencia,_this.ofertaRealizada,_this.interesCliente,_this.pedidoRealizado,_this.codigoMotivoNoInteres,_this.codigoMotivoNoPedido,_this.codigoSector,_this.codigoCompetencia,_this.almacenPropio,_this.capacidad,_this.frecuenciaPedido,_this.latitud,_this.longitud,_this.visitaAppId,_this.lastUpdated,_this.deleted]);
}

@override
String toString() {
  final _this = this as VisitaDTO;
  return 'VisitaDTO(id: ${_this.id}, fecha: ${_this.fecha}, clienteId: ${_this.clienteId}, isClienteProvisional: ${_this.isClienteProvisional}, clienteProvisionalNombre: ${_this.clienteProvisionalNombre}, clienteProvisionalEmail: ${_this.clienteProvisionalEmail}, clienteProvisionalTelefono: ${_this.clienteProvisionalTelefono}, clienteProvisionalPoblacion: ${_this.clienteProvisionalPoblacion}, numEmpl: ${_this.numEmpl}, contacto: ${_this.contacto}, atendidoPor: ${_this.atendidoPor}, resumen: ${_this.resumen}, marcasCompetencia: ${_this.marcasCompetencia}, ofertaRealizada: ${_this.ofertaRealizada}, interesCliente: ${_this.interesCliente}, pedidoRealizado: ${_this.pedidoRealizado}, codigoMotivoNoInteres: ${_this.codigoMotivoNoInteres}, codigoMotivoNoPedido: ${_this.codigoMotivoNoPedido}, codigoSector: ${_this.codigoSector}, codigoCompetencia: ${_this.codigoCompetencia}, almacenPropio: ${_this.almacenPropio}, capacidad: ${_this.capacidad}, frecuenciaPedido: ${_this.frecuenciaPedido}, latitud: ${_this.latitud}, longitud: ${_this.longitud}, visitaAppId: ${_this.visitaAppId}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
