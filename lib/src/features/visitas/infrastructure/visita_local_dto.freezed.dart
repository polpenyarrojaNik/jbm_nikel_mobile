...
int get hashCode {
  final _this = this as VisitaLocalDTO;
  return Object.hashAll([runtimeType,_this.visitaAppId,_this.fecha,_this.clienteId,_this.isClienteProvisional,_this.clienteProvisionalNombre,_this.clienteProvisionalEmail,_this.clienteProvisionalTelefono,_this.clienteProvisionalDireccion1,_this.clienteProvisionalDireccion2,_this.clienteProvisionalCodigoPostal,_this.clienteProvisionalPoblacion,_this.clienteProvisionalProvinciaId,_this.clienteProvisionalRegionId,_this.clienteProvisionalPaisId,_this.numEmpl,_this.contacto,_this.atendidoPor,_this.resumen,_this.marcasCompetencia,_this.ofertaRealizada,_this.interesCliente,_this.pedidoRealizado,_this.codigoMotivoNoInteres,_this.codigoMotivoNoPedido,_this.codigoSector,_this.codigoCompetencia,_this.almacenPropio,_this.capacidad,_this.frecuenciaPedido,_this.latitud,_this.longitud,_this.enviada,_this.tratada,_this.errorSyncMessage]);
}

@override
String toString() {
  final _this = this as VisitaLocalDTO;
  return 'VisitaLocalDTO(visitaAppId: ${_this.visitaAppId}, fecha: ${_this.fecha}, clienteId: ${_this.clienteId}, isClienteProvisional: ${_this.isClienteProvisional}, clienteProvisionalNombre: ${_this.clienteProvisionalNombre}, clienteProvisionalEmail: ${_this.clienteProvisionalEmail}, clienteProvisionalTelefono: ${_this.clienteProvisionalTelefono}, clienteProvisionalDireccion1: ${_this.clienteProvisionalDireccion1}, clienteProvisionalDireccion2: ${_this.clienteProvisionalDireccion2}, clienteProvisionalCodigoPostal: ${_this.clienteProvisionalCodigoPostal}, clienteProvisionalPoblacion: ${_this.clienteProvisionalPoblacion}, clienteProvisionalProvinciaId: ${_this.clienteProvisionalProvinciaId}, clienteProvisionalRegionId: ${_this.clienteProvisionalRegionId}, clienteProvisionalPaisId: ${_this.clienteProvisionalPaisId}, numEmpl: ${_this.numEmpl}, contacto: ${_this.contacto}, atendidoPor: ${_this.atendidoPor}, resumen: ${_this.resumen}, marcasCompetencia: ${_this.marcasCompetencia}, ofertaRealizada: ${_this.ofertaRealizada}, interesCliente: ${_this.interesCliente}, pedidoRealizado: ${_this.pedidoRealizado}, codigoMotivoNoInteres: ${_this.codigoMotivoNoInteres}, codigoMotivoNoPedido: ${_this.codigoMotivoNoPedido}, codigoSector: ${_this.codigoSector}, codigoCompetencia: ${_this.codigoCompetencia}, almacenPropio: ${_this.almacenPropio}, capacidad: ${_this.capacidad}, frecuenciaPedido: ${_this.frecuenciaPedido}, latitud: ${_this.latitud}, longitud: ${_this.longitud}, enviada: ${_this.enviada}, tratada: ${_this.tratada}, errorSyncMessage: ${_this.errorSyncMessage})';
}
