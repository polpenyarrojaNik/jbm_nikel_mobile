...
bool operator ==(Object other) {
  final _this = this as VisitaSector;
...
String toString() {
  final _this = this as VisitaSector;
  return 'VisitaSector(id: ${_this.id}, descripcion: ${_this.descripcion}, lastUpdate: ${_this.lastUpdate}, deleted: ${_this.deleted})';
}
