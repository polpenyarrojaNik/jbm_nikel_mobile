...
abstract class $UserDTOCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'CLAVE') String password,
      @JsonKey(name: 'NOMBRE_MOSTRAR', defaultValue: '') String? username,
...
class _$_UserDTO extends _UserDTO {
  const _$_UserDTO(
      ...
      @JsonKey(name: 'CLAVE') required this.password,
      @JsonKey(name: 'NOMBRE_MOSTRAR', defaultValue: '') required this.username,
  ...
  @override
  String toString() {
    return 'UserDTO(id: $id, user: $user, password: $password, username: $username, provisionalToken: $provisionalToken, refreshToken: $refreshToken)';
  }
