...
bool operator ==(Object other) {
  final _this = this as Devolucion;
...
int get hashCode {
  final _this = this as Devolucion;
  return Object.hash(runtimeType,_this.empresaId,_this.id,_this.fechaDevolucion,_this.clienteId,_this.direccionId,_this.nombre,_this.direccionRecogida1,_this.direccionRecogida2,_this.codigoPostal,_this.poblacion,_this.pais,_this.almacenDestino,_this.agenciaTransporte,_this.devolucionEstado,_this.kilosDevolucion,_this.bultos,_this.lastUpdated,_this.deleted);
}

@override
String toString() {
  final _this = this as Devolucion;
  return 'Devolucion(empresaId: ${_this.empresaId}, id: ${_this.id}, fechaDevolucion: ${_this.fechaDevolucion}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombre: ${_this.nombre}, direccionRecogida1: ${_this.direccionRecogida1}, direccionRecogida2: ${_this.direccionRecogida2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, pais: ${_this.pais}, almacenDestino: ${_this.almacenDestino}, agenciaTransporte: ${_this.agenciaTransporte}, devolucionEstado: ${_this.devolucionEstado}, kilosDevolucion: ${_this.kilosDevolucion}, bultos: ${_this.bultos}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,empresaId,id,fechaDevolucion,clienteId,direccionId,nombre,direccionRecogida1,direccionRecogida2,codigoPostal,poblacion,pais,almacenDestino,agenciaTransporte,devolucionEstado,kilosDevolucion,bultos,lastUpdated,deleted);
}
