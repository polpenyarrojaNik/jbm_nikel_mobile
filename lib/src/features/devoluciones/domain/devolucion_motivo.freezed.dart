...
mixin _$DevolucionMotivo {
  ...
  @JsonKey(ignore: true)
  $DevolucionMotivoCopyWith<DevolucionMotivo> get copyWith =>
...
/// @nodoc
class _$DevolucionMotivoCopyWithImpl<$Res, $Val extends DevolucionMotivo>
    implements $DevolucionMotivoCopyWith<$Res> {
  _$DevolucionMotivoCopyWithImpl(this._value, this._then);
