...
part 'devolucion_motivo_dto.freezed.dart';
part 'devolucion_motivo_dto.g.dart';
...
class DevolucionMotivoDTO
  ...
  const factory DevolucionMotivoDTO({
    @JsonKey(name: 'DEVOLUCION_MOTIVO_ID') required String id,
  ...
  }) = _DevolucionMotivoDTO;

  factory DevolucionMotivoDTO.fromJson(Map<String, dynamic> json) =>
      _$DevolucionMotivoDTOFromJson(json);
...
@UseRowClass(DevolucionMotivoDTO)
class DevolucionMotivoTable extends Table {
  @override
  String get tableName => 'DEVOLUCIONES_MOTIVOS';

  @override
  Set<Column> get primaryKey => {id};

  TextColumn get id => text().named('DEVOLUCION_MOTIVO_ID')();
