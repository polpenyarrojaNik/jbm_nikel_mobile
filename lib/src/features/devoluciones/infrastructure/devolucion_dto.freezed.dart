...
bool operator ==(Object other) {
  final _this = this as DevolucionDTO;
  return identical(this, other) || (other.runtimeType == runtimeType&&other is DevolucionDTO&&(identical(other.empresaId, _this.empresaId) || other.empresaId == _this.empresaId)&&(identical(other.id, _this.id) || other.id == _this.id)&&(identical(other.fechaDevolucion, _this.fechaDevolucion) || other.fechaDevolucion == _this.fechaDevolucion)&&(identical(other.clienteId, _this.clienteId) || other.clienteId == _this.clienteId)&&(identical(other.direccionId, _this.direccionId) || other.direccionId == _this.direccionId)&&(identical(other.nombre, _this.nombre) || other.nombre == _this.nombre)&&(identical(other.direccionRecogida1, _this.direccionRecogida1) || other.direccionRecogida1 == _this.direccionRecogida1)&&(identical(other.direccionRecogida2, _this.direccionRecogida2) || other.direccionRecogida2 == _this.direccionRecogida2)&&(identical(other.codigoPostal, _this.codigoPostal) || other.codigoPostal == _this.codigoPostal)&&(identical(other.poblacion, _this.poblacion) || other.poblacion == _this.poblacion)&&(identical(other.paisId, _this.paisId) || other.paisId == _this.paisId)&&(identical(other.almacenDestino, _this.almacenDestino) || other.almacenDestino == _this.almacenDestino)&&(identical(other.agenciaTransporte, _this.agenciaTransporte) || other.agenciaTransporte == _this.agenciaTransporte)&&(identical(other.devolucionEstadoId, _this.devolucionEstadoId) || other.devolucionEstadoId == _this.devolucionEstadoId)&&(identical(other.kilosDevolucion, _this.kilosDevolucion) || other.kilosDevolucion == _this.kilosDevolucion)&&(identical(other.bultos, _this.bultos) || other.bultos == _this.bultos)&&(identical(other.lastUpdated, _this.lastUpdated) || other.lastUpdated == _this.lastUpdated)&&(identical(other.deleted, _this.deleted) || other.deleted == _this.deleted));
}
...
int get hashCode {
  final _this = this as DevolucionDTO;
  return Object.hash(runtimeType,_this.empresaId,_this.id,_this.fechaDevolucion,_this.clienteId,_this.direccionId,_this.nombre,_this.direccionRecogida1,_this.direccionRecogida2,_this.codigoPostal,_this.poblacion,_this.paisId,_this.almacenDestino,_this.agenciaTransporte,_this.devolucionEstadoId,_this.kilosDevolucion,_this.bultos,_this.lastUpdated,_this.deleted);
}

@override
String toString() {
  final _this = this as DevolucionDTO;
  return 'DevolucionDTO(empresaId: ${_this.empresaId}, id: ${_this.id}, fechaDevolucion: ${_this.fechaDevolucion}, clienteId: ${_this.clienteId}, direccionId: ${_this.direccionId}, nombre: ${_this.nombre}, direccionRecogida1: ${_this.direccionRecogida1}, direccionRecogida2: ${_this.direccionRecogida2}, codigoPostal: ${_this.codigoPostal}, poblacion: ${_this.poblacion}, paisId: ${_this.paisId}, almacenDestino: ${_this.almacenDestino}, agenciaTransporte: ${_this.agenciaTransporte}, devolucionEstadoId: ${_this.devolucionEstadoId}, kilosDevolucion: ${_this.kilosDevolucion}, bultos: ${_this.bultos}, lastUpdated: ${_this.lastUpdated}, deleted: ${_this.deleted})';
}
...
@override
int get hashCode {
    return Object.hash(runtimeType,empresaId,id,fechaDevolucion,clienteId,direccionId,nombre,direccionRecogida1,direccionRecogida2,codigoPostal,poblacion,paisId,almacenDestino,agenciaTransporte,devolucionEstadoId,kilosDevolucion,bultos,lastUpdated,deleted);
}
