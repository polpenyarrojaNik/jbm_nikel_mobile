...
_$_DevolucionEstadoDTO _$$_DevolucionEstadoDTOFromJson(
        Map<String, dynamic> json) =>
    _$_DevolucionEstadoDTO(
...
Map<String, dynamic> _$$_DevolucionEstadoDTOToJson(
        _$_DevolucionEstadoDTO instance) =>
    <String, dynamic>{
