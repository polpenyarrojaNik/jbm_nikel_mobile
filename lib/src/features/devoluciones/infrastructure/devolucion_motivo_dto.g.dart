...
_$_DevolucionMotivoDTO _$$_DevolucionMotivoDTOFromJson(
        Map<String, dynamic> json) =>
    _$_DevolucionMotivoDTO(
...
Map<String, dynamic> _$$_DevolucionMotivoDTOToJson(
        _$_DevolucionMotivoDTO instance) =>
    <String, dynamic>{
