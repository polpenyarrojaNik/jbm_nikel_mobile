...
_EstadisticasUltimosPreciosDTO _$EstadisticasUltimosPreciosDTOFromJson(
  Map<String, dynamic> json,
) => _EstadisticasUltimosPreciosDTO(
  clienteId: json['CLIENTE_ID'] as String,
  articuloId: json['ARTICULO_ID'] as String,
  linea: (json['LINEA'] as num).toInt(),
...
Map<String, dynamic> _$EstadisticasUltimosPreciosDTOToJson(
  _EstadisticasUltimosPreciosDTO instance,
) => <String, dynamic>{
