...
class _$_SalesOrderHeaders extends _SalesOrderHeaders {
  const _$_SalesOrderHeaders({this.maxPage}) : super._();
  ...
  @override
  String toString() {
    return 'SalesOrderHeaders(maxPage: $maxPage)';
  }
...
abstract class _SalesOrderHeaders extends SalesOrderHeaders {
  const factory _SalesOrderHeaders({final int? maxPage}) = _$_SalesOrderHeaders;
